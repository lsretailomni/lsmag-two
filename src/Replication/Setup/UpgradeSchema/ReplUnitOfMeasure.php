...
class ReplUnitOfMeasure
{
    ...
    public function upgrade(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if(!$setup->tableExists($table_name)) {
        	...
        	$table->addColumn('repl_unit_of_measure_id', Table::TYPE_INTEGER, 11, [ 'identity' => TRUE, 'primary' => TRUE, 'unsigned' => TRUE, 'nullable' => FALSE, 'auto_increment'=> TRUE ]);
        	...
        	$table->addColumn('UnitDecimals' , Table::TYPE_INTEGER, 11);
