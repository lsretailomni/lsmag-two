    ...
    public function upgrade(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if(!$setup->tableExists($table_name)) {
        	...
        	if ($connection->tableColumnExists($table_name, 'VariantDimension1' ) === false) {
        		$connection->addColumn($table_name, 'VariantDimension1', ['default' => null,'type' => Table::TYPE_TEXT, 'comment' => 'VariantDimension1']);
        	}
        	if ($connection->tableColumnExists($table_name, 'VariantDimension2' ) === false) {
        		$connection->addColumn($table_name, 'VariantDimension2', ['default' => null,'type' => Table::TYPE_TEXT, 'comment' => 'VariantDimension2']);
        	}
        	if ($connection->tableColumnExists($table_name, 'VariantDimension3' ) === false) {
        		$connection->addColumn($table_name, 'VariantDimension3', ['default' => null,'type' => Table::TYPE_TEXT, 'comment' => 'VariantDimension3']);
        	}
        	if ($connection->tableColumnExists($table_name, 'VariantDimension4' ) === false) {
        		$connection->addColumn($table_name, 'VariantDimension4', ['default' => null,'type' => Table::TYPE_TEXT, 'comment' => 'VariantDimension4']);
        	}
        	if ($connection->tableColumnExists($table_name, 'VariantDimension5' ) === false) {
        		$connection->addColumn($table_name, 'VariantDimension5', ['default' => null,'type' => Table::TYPE_TEXT, 'comment' => 'VariantDimension5']);
        	}
        	if ($connection->tableColumnExists($table_name, 'VariantDimension6' ) === false) {
        		$connection->addColumn($table_name, 'VariantDimension6', ['default' => null,'type' => Table::TYPE_TEXT, 'comment' => 'VariantDimension6']);
        	}
