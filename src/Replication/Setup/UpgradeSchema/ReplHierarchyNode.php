...
class ReplHierarchyNode
{
    ...
    public function upgrade(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if(!$setup->tableExists($table_name)) {
        	...
        	$table->addColumn('repl_hierarchy_node_id', Table::TYPE_INTEGER, 11, [ 'identity' => TRUE, 'primary' => TRUE, 'unsigned' => TRUE, 'nullable' => FALSE, 'auto_increment'=> TRUE ]);
        	...
        	$table->addColumn('ChildrenOrder' , Table::TYPE_INTEGER, 11);
        	...
        	$table->addColumn('Indentation' , Table::TYPE_INTEGER, 11);
        	$table->addColumn('IsDeleted' , Table::TYPE_BOOLEAN, 1);
        	$table->addColumn('ParentNode' , Table::TYPE_TEXT, '');
        	$table->addColumn('PresentationOrder' , Table::TYPE_INTEGER, 11);
