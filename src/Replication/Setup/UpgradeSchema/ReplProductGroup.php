...
class ReplProductGroup
{
    ...
    public function upgrade(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if(!$setup->tableExists($table_name)) {
        	...
        	$table->addColumn('repl_product_group_id', Table::TYPE_INTEGER, NULL, 
        	...
        	if ($connection->tableColumnExists($table_name, 'ItemCategoryID' ) === false) {
        		$connection->addColumn($table_name, 'ItemCategoryID', ['default' => null,'type' => Table::TYPE_TEXT, 'comment' => 'ItemCategoryID']);
        	}
