...
class ReplProductGroup
{
    ...
    {
        $table_name = $setup->getTable( 'ls_replication_repl_product_group' ); 
        if(!$setup->tableExists($table_name)) {
        	$table = $setup->getConnection()->newTable( $table_name );
        	$table->addColumn('repl_product_group_id', Table::TYPE_INTEGER, 11, [ 'identity' => TRUE, 'primary' => TRUE, 'unsigned' => TRUE, 'nullable' => FALSE, 'auto_increment'=> TRUE ]);
        	...
        	if ($connection->tableColumnExists($table_name, 'ItemCategoryID' ) === false) {
        		$connection->addColumn($table_name, 'ItemCategoryID', ['length' => '','default' => null,'type' => Table::TYPE_TEXT, 'comment' => 'ItemCategoryID']);
        	} else {
        		$connection->modifyColumn($table_name, 'ItemCategoryID', ['length' => '','default' => null,'type' => Table::TYPE_TEXT, 'comment' => 'ItemCategoryID']);
        	}
