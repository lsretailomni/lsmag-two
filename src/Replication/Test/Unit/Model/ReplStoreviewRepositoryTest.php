...
use \Ls\Replication\Model\ReplStoreviewRepository;
...
use \Ls\Replication\Api\Data\ReplStoreviewSearchResultsInterface;
use \Ls\Replication\Model\ReplStoreviewFactory;
use \Ls\Replication\Model\ReplStoreviewSearchResultsFactory;

class ReplStoreviewRepositoryTest extends TestCase
{
    /**
     * @property Ls\Omni\Client\Ecommerce\Entity\StoreViewFactory $objectFactory
     */
    ...
    {
        $this->objectFactory = $this->createPartialMock(Ls\Omni\Client\Ecommerce\Entity\StoreViewFactory::class, ['create']);
