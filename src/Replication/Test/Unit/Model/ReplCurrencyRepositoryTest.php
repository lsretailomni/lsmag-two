...
{
    /**
     * @property Ls\Omni\Client\Ecommerce\Entity\CurrencyFactory $objectFactory
     */
    ...
    {
        $this->objectFactory = $this->createPartialMock(Ls\Omni\Client\Ecommerce\Entity\CurrencyFactory::class, ['create']);
