...
{
    /**
     * @property Ls\Omni\Client\Ecommerce\Entity\UnitofMeasureFactory $objectFactory
     */
    ...
    {
        $this->objectFactory = $this->createPartialMock(Ls\Omni\Client\Ecommerce\Entity\UnitofMeasureFactory::class, ['create']);
