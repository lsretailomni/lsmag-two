...
use \Ls\Replication\Model\ResourceModel\ReplItemModifier\CollectionFactory;
...
use \Ls\Replication\Model\ReplItemModifierSearchResultsFactory;

class ReplItemModifierRepositoryTest extends TestCase
{
    /**
     * @property ReplItemModifierFactory $objectFactory
     */
    ...
    /**
     * @property ReplItemModifierSearchResultsFactory $resultFactory
     */
    protected $resultFactory = null;

    /**
     * @property ReplItemModifierRepository $model
     */
    private $model = null;

    /**
     * @property ReplItemModifierInterface $entityInterface
     */
    private $entityInterface = null;

    /**
     * @property ReplItemModifierSearchResultsInterface $entitySearchResultsInterface
     */
    ...
    protected function setUp(): void
    {
        ...
        $this->resultFactory = $this->createMock(ReplItemModifierSearchResultsFactory::class);
        $this->entityInterface = $this->createMock(ReplItemModifierInterface::class);
        $this->entitySearchResultsInterface = $this->createMock(ReplItemModifierSearchResultsInterface::class);
        $this->model = new ReplItemModifierRepository(
                $this->objectFactory,
    ...
    {
        $entityId = 1;
        $entityMock = $this->createMock(ReplItemModifierRepository::class);
