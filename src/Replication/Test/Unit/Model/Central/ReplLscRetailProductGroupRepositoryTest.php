...
use \Ls\Replication\Model\Central\ReplLscRetailProductGroupRepository;
...
{
    /**
     * @property Ls\Omni\Client\CentralEcommerce\Entity\LSCRetailProductGroupFactory
     * $objectFactory
     */
    ...
    {
        $this->objectFactory = $this->createPartialMock(Ls\Omni\Client\CentralEcommerce\Entity\LSCRetailProductGroupFactory::class, ['create']);
