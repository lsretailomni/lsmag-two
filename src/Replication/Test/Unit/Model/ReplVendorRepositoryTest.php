...
{
    /**
     * @property Ls\Omni\Client\Ecommerce\Entity\VendorFactory $objectFactory
     */
    ...
    {
        $this->objectFactory = $this->createPartialMock(Ls\Omni\Client\Ecommerce\Entity\VendorFactory::class, ['create']);
