 ...
 */
class ItemVendorDataProviderTest extends AbstractDataProvider
{
    public const DATA_SOURCE_NAME = 'ls_repl_grids_item_vendor_data_source';
    public const PRIMARY_FIELD_NAME = 'repl_loy_vendor_item_mapping_id';
    public const REQUEST_FIELD_NAME = 'id';
    public const SEARCH_FIELD_NAME = 'NavManufacturerId';
    ...
    {
        return AbstractIntegrationTest::SAMPLE_VENDOR_ID;
    }
