 ...
 */
class UomDataProviderTest extends AbstractDataProvider
{
    public const DATA_SOURCE_NAME = 'ls_repl_grids_uom_data_source';
    public const PRIMARY_FIELD_NAME = 'repl_unit_of_measure_id';
    ...
    {
        return AbstractIntegrationTest::SAMPLE_UOM;
    }
