 ...
 */
class AttributeDataProviderTest extends AbstractDataProvider
{
    public const DATA_SOURCE_NAME = 'ls_repl_grids_attribute_data_source';
    public const PRIMARY_FIELD_NAME = 'repl_attribute_id';
