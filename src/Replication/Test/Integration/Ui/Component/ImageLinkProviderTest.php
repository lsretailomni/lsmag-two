 ...
 */
class ImageLinkProviderTest extends AbstractDataProvider
{
    public const DATA_SOURCE_NAME = 'ls_repl_grids_imagelink_data_source';
    public const PRIMARY_FIELD_NAME = 'repl_image_link_id';
    public const REQUEST_FIELD_NAME = 'id';
    public const SEARCH_FIELD_NAME = 'KeyValue';
