 ...
 */
class AttributeValueDataProviderTest extends AbstractDataProvider
{
    public const DATA_SOURCE_NAME = 'ls_repl_grids_attributevalue_data_source';
    public const PRIMARY_FIELD_NAME = 'repl_attribute_value_id';
