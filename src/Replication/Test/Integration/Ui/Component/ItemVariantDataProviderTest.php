...
use \Ls\Replication\Cron\ReplEcommItemVariantTask;
 ...
 */
class ItemVariantDataProviderTest extends AbstractDataProvider
{
    public const DATA_SOURCE_NAME = 'ls_repl_grids_itemvariant_data_source';
    public const PRIMARY_FIELD_NAME = 'repl_item_variant_id';
    ...
    #[
        ...
        DataFixture(
            ...
            [
                'job_url' => ReplEcommItemVariantTask::class,
