 ...
 */
class DiscountValidationDataProviderTest extends AbstractDataProvider
{
    public const DATA_SOURCE_NAME = 'ls_repl_grids_discount_validation_data_source';
    public const PRIMARY_FIELD_NAME = 'repl_discount_validation_id';
    ...
    {
        return AbstractIntegrationTest::SAMPLE_VALIDATION_PERIOD_ID;
    }
