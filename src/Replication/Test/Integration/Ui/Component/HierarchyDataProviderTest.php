...
use \Ls\Replication\Cron\ReplLscHierarchyviewTask;
 ...
 */
class HierarchyDataProviderTest extends AbstractDataProvider
{
    public const DATA_SOURCE_NAME = 'ls_repl_grids_hierarchy_data_source';
    public const PRIMARY_FIELD_NAME = 'repl_hierarchy_id';
    ...
    #[
        ...
        DataFixture(
            ...
            [
                'job_url' => ReplLscHierarchyviewTask::class,
