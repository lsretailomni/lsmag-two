 ...
 */
class DiscountSetupDataProviderTest extends AbstractDataProvider
{
    public const DATA_SOURCE_NAME = 'ls_repl_grids_discount_setup_data_source';
    public const PRIMARY_FIELD_NAME = 'repl_discount_setup_id';
    public const REQUEST_FIELD_NAME = 'id';
    public const SEARCH_FIELD_NAME = 'OfferNo';
    ...
    {
        return AbstractIntegrationTest::SAMPLE_OFFER_NO;
    }
