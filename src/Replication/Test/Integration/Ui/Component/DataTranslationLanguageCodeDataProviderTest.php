 ...
 */
class DataTranslationLanguageCodeDataProviderTest extends AbstractDataProvider
{
    public const DATA_SOURCE_NAME = 'ls_repl_grids_data_translation_lang_code_data_source';
    public const PRIMARY_FIELD_NAME = 'repl_data_translation_lang_code_id';
