 ...
 */
class ItemVariantRegistrationDataProviderTest extends AbstractDataProvider
{
    public const DATA_SOURCE_NAME = 'ls_repl_grids_itemvariantregistration_data_source';
    public const PRIMARY_FIELD_NAME = 'repl_item_variant_registration_id';
