 ...
 */
class CountryCodeDataProviderTest extends AbstractDataProvider
{
    public const DATA_SOURCE_NAME = 'ls_repl_grids_country_code_data_source';
    public const PRIMARY_FIELD_NAME = 'repl_country_code_id';
    ...
    {
        return AbstractIntegrationTest::SAMPLE_COUNTRY_CODE;
    }
