 ...
 */
class TaxDataProviderTest extends AbstractDataProvider
{
    public const DATA_SOURCE_NAME = 'ls_repl_grids_tax_setup_data_source';
    public const PRIMARY_FIELD_NAME = 'repl_tax_setup_id';
    public const REQUEST_FIELD_NAME = 'id';
    public const SEARCH_FIELD_NAME = 'BusinessTaxGroup';
    ...
    {
        return AbstractIntegrationTest::SAMPLE_BUSINESS_TAX_GROUP;
    }
