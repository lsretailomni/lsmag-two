 ...
 */
class StoreTenderTypeDataProviderTest extends AbstractDataProvider
{
    public const DATA_SOURCE_NAME = 'ls_repl_grids_store_tender_type_data_source';
    public const PRIMARY_FIELD_NAME = 'repl_store_tender_type_id';
    public const REQUEST_FIELD_NAME = 'id';
    public const SEARCH_FIELD_NAME = 'TenderTypeId';
    ...
    {
        return AbstractIntegrationTest::SAMPLE_CASH_TENDER_TYPE_ID;
    }
