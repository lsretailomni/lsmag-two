 ...
 */
class VendorDataProviderTest extends AbstractDataProvider
{
    public const DATA_SOURCE_NAME = 'ls_repl_grids_vendor_data_source';
    public const PRIMARY_FIELD_NAME = 'repl_vendor_id';
