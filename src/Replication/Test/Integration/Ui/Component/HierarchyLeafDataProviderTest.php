 ...
 */
class HierarchyLeafDataProviderTest extends AbstractDataProvider
{
    public const DATA_SOURCE_NAME = 'ls_repl_grids_hierarchyleaf_data_source';
    public const PRIMARY_FIELD_NAME = 'repl_hierarchy_leaf_id';
