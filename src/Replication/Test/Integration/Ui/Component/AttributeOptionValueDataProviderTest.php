 ...
 */
class AttributeOptionValueDataProviderTest extends AbstractDataProvider
{
    public const DATA_SOURCE_NAME = 'ls_repl_grids_attributeoptionvalue_data_source';
    public const PRIMARY_FIELD_NAME = 'repl_attribute_option_value_id';
    public const REQUEST_FIELD_NAME = 'id';
    public const SEARCH_FIELD_NAME = 'Code';
    ...
    {
        return AbstractIntegrationTest::SAMPLE_ATTRIBUTE_CODE;
    }
