 ...
 */
class AttributeOptionValueTest extends AbstractGrid
{
    #[
    ...
    {
        $this->assertPageName(__('Attribute Option Value Replication'));
    }

    public function getUri()
    {
        return 'backend/ls_repl/grids/attributeoptionvalue';
    }
}
