 ...
 */
class ItemVariantRegistrationTest extends AbstractGrid
{
    #[
    ...
    {
        $this->assertPageName(__('Item Variant Registration Replication'));
    }

    public function getUri()
    {
        return 'backend/ls_repl/grids/itemvariantregistration';
    }
}
