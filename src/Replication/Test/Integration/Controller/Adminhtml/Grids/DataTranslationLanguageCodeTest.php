 ...
 */
class DataTranslationLanguageCodeTest extends AbstractGrid
{
    #[
    ...
    {
        $this->assertPageName(__('Data Translation Lang Code Replication'));
    }

    public function getUri()
    {
        return 'backend/ls_repl/grids/datatranslationlangcode';
    }
}
