...
class ReplHierarchyHospDealLineRepository implements ReplHierarchyHospDealLineRepositoryInterface
{
    ...
    /**
     * @property ReplHierarchyHospDealLineSearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplHierarchyHospDealLineFactory $object_factory, CollectionFactory $collection_factory, ReplHierarchyHospDealLineSearchResultsFactory $result_factory)
    {
    ...
    public function save(ReplHierarchyHospDealLineInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ReplHierarchyHospDealLineInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
