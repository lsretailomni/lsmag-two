...
class ReplHierarchyHospDealRepository implements ReplHierarchyHospDealRepositoryInterface
{
    ...
    /**
     * @property ReplHierarchyHospDealSearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplHierarchyHospDealFactory $object_factory, CollectionFactory $collection_factory, ReplHierarchyHospDealSearchResultsFactory $result_factory)
    {
    ...
    public function save(ReplHierarchyHospDealInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ReplHierarchyHospDealInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
