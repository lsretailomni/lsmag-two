...
class ReplAttributeOptionValueRepository implements ReplAttributeOptionValueRepositoryInterface
{
    ...
    /**
     * @property ReplAttributeOptionValueSearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplAttributeOptionValueFactory $object_factory, CollectionFactory $collection_factory, ReplAttributeOptionValueSearchResultsFactory $result_factory)
    {
    ...
    public function save(ReplAttributeOptionValueInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ReplAttributeOptionValueInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
