...
class ReplValidationScheduleRepository implements ReplValidationScheduleRepositoryInterface
{
    ...
    /**
     * @property ReplValidationScheduleSearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplValidationScheduleFactory $object_factory, CollectionFactory $collection_factory, ReplValidationScheduleSearchResultsFactory $result_factory)
    {
    ...
    public function save(ReplValidationScheduleInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ReplValidationScheduleInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
