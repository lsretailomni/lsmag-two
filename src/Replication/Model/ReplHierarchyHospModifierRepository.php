...
class ReplHierarchyHospModifierRepository implements ReplHierarchyHospModifierRepositoryInterface
{

    /**
     * @property ReplHierarchyHospModifierFactory $object_factory
     */
    ...
    /**
     * @property ReplHierarchyHospModifierSearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplHierarchyHospModifierFactory $object_factory, CollectionFactory $collection_factory, ReplHierarchyHospModifierSearchResultsFactory $result_factory)
    {
    ...
    public function save(ReplHierarchyHospModifierInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ReplHierarchyHospModifierInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
