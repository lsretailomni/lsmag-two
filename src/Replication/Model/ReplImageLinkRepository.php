...
class ReplImageLinkRepository implements ReplImageLinkRepositoryInterface
{
    ...
    /**
     * @property ReplImageLinkSearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplImageLinkFactory $object_factory, CollectionFactory $collection_factory, ReplImageLinkSearchResultsFactory $result_factory)
    {
    ...
    public function save(ReplImageLinkInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ReplImageLinkInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
