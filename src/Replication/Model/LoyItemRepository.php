...
class LoyItemRepository implements LoyItemRepositoryInterface
{
    ...
    /**
     * @property LoyItemSearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(LoyItemFactory $object_factory, CollectionFactory $collection_factory, LoyItemSearchResultsFactory $result_factory)
    {
    ...
    public function save(LoyItemInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(LoyItemInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
