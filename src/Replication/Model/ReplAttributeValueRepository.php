...
class ReplAttributeValueRepository implements ReplAttributeValueRepositoryInterface
{

    /**
     * @property ReplAttributeValueFactory $object_factory
     */
    ...
    /**
     * @property ReplAttributeValueSearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplAttributeValueFactory $object_factory, CollectionFactory $collection_factory, ReplAttributeValueSearchResultsFactory $result_factory)
    {
    ...
    public function save(ReplAttributeValueInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ReplAttributeValueInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
