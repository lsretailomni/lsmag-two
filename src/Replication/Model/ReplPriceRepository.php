...
class ReplPriceRepository implements ReplPriceRepositoryInterface
{
    ...
    /**
     * @property ReplPriceSearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplPriceFactory $object_factory, CollectionFactory $collection_factory, ReplPriceSearchResultsFactory $result_factory)
    {
    ...
    public function save(ReplPriceInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ReplPriceInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
