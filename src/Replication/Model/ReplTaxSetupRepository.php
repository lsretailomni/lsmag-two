...
class ReplTaxSetupRepository implements ReplTaxSetupRepositoryInterface
{
    ...
    /**
     * @property ReplTaxSetupSearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplTaxSetupFactory $object_factory, CollectionFactory $collection_factory, ReplTaxSetupSearchResultsFactory $result_factory)
    {
    ...
    public function save(ReplTaxSetupInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ReplTaxSetupInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
