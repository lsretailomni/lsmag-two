...
class ReplLoyVendorItemMappingRepository implements ReplLoyVendorItemMappingRepositoryInterface
{
    ...
    /**
     * @property ReplLoyVendorItemMappingSearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplLoyVendorItemMappingFactory $object_factory, CollectionFactory $collection_factory, ReplLoyVendorItemMappingSearchResultsFactory $result_factory)
    {
    ...
    public function save(ReplLoyVendorItemMappingInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ReplLoyVendorItemMappingInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
