...
class ReplItemCategoryRepository implements ReplItemCategoryRepositoryInterface
{
    ...
    /**
     * @property ReplItemCategorySearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplItemCategoryFactory $object_factory, CollectionFactory $collection_factory, ReplItemCategorySearchResultsFactory $result_factory)
    {
