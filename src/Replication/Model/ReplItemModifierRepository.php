...
class ReplItemModifierRepository implements ReplItemModifierRepositoryInterface
{
    ...
    /**
     * @property ReplItemModifierSearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplItemModifierFactory $object_factory, CollectionFactory $collection_factory, ReplItemModifierSearchResultsFactory $result_factory)
    {
    ...
    public function save(ReplItemModifierInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ReplItemModifierInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
