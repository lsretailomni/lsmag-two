...
class ReplProductGroupRepository implements ReplProductGroupRepositoryInterface
{

    /**
     * @property ReplProductGroupFactory $object_factory
     */
    ...
    /**
     * @property ReplProductGroupSearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplProductGroupFactory $object_factory, CollectionFactory $collection_factory, ReplProductGroupSearchResultsFactory $result_factory)
    {
    ...
    public function save(ReplProductGroupInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ReplProductGroupInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
