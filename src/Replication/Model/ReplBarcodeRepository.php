...
class ReplBarcodeRepository implements ReplBarcodeRepositoryInterface
{
    ...
    /**
     * @property ReplBarcodeSearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplBarcodeFactory $object_factory, CollectionFactory $collection_factory, ReplBarcodeSearchResultsFactory $result_factory)
    {
    ...
    public function save(ReplBarcodeInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ReplBarcodeInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
