...
class ReplItemUnitOfMeasureRepository implements ReplItemUnitOfMeasureRepositoryInterface
{
    /**
     * @property ReplItemUnitOfMeasureFactory $object_factory
     */
    ...
    /**
     * @property ReplItemUnitOfMeasureSearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplItemUnitOfMeasureFactory $object_factory, CollectionFactory $collection_factory, ReplItemUnitOfMeasureSearchResultsFactory $result_factory)
    {
    ...
    public function save(ReplItemUnitOfMeasureInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ReplItemUnitOfMeasureInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
