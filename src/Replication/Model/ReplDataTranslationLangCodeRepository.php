...
class ReplDataTranslationLangCodeRepository implements ReplDataTranslationLangCodeRepositoryInterface
{
    ...
    /**
     * @property ReplDataTranslationLangCodeSearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplDataTranslationLangCodeFactory $object_factory, CollectionFactory $collection_factory, ReplDataTranslationLangCodeSearchResultsFactory $result_factory)
    {
    ...
    public function save(ReplDataTranslationLangCodeInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ReplDataTranslationLangCodeInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
