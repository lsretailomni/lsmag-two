...
class ReplImageRepository implements ReplImageRepositoryInterface
{

    /**
     * @property ReplImageFactory $object_factory
     */
    ...
    /**
     * @property ReplImageSearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplImageFactory $object_factory, CollectionFactory $collection_factory, ReplImageSearchResultsFactory $result_factory)
    {
    ...
    public function save(ReplImageInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ReplImageInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
