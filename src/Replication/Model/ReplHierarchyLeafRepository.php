...
class ReplHierarchyLeafRepository implements ReplHierarchyLeafRepositoryInterface
{
    /**
     * @property ReplHierarchyLeafFactory $object_factory
     */
    ...
    /**
     * @property ReplHierarchyLeafSearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplHierarchyLeafFactory $object_factory, CollectionFactory $collection_factory, ReplHierarchyLeafSearchResultsFactory $result_factory)
    {
    ...
    public function save(ReplHierarchyLeafInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ReplHierarchyLeafInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
