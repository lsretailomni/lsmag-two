...
class ReplCollectionRepository implements ReplCollectionRepositoryInterface
{
    /**
     * @property ReplCollectionFactory $object_factory
     */
    ...
    /**
     * @property ReplCollectionSearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplCollectionFactory $object_factory, CollectionFactory $collection_factory, ReplCollectionSearchResultsFactory $result_factory)
    {
    ...
    public function save(ReplCollectionInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ReplCollectionInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
