...
class ReplDataTranslationRepository implements ReplDataTranslationRepositoryInterface
{
    ...
    /**
     * @property ReplDataTranslationSearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplDataTranslationFactory $object_factory, CollectionFactory $collection_factory, ReplDataTranslationSearchResultsFactory $result_factory)
    {
    ...
    public function save(ReplDataTranslationInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ReplDataTranslationInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
