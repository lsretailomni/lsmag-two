...
class ReplLscItemVariantRegistration extends \Ls\Omni\Client\CentralEcommerce\Entity\LSCItemVariantRegistration implements ReplLscItemVariantRegistrationInterface, IdentityInterface
{
    public const CACHE_TAG = 'ls_replication_repl_lsc_item_variant_registration';

    protected $_cacheTag = 'ls_replication_repl_lsc_item_variant_registration';

    protected $_eventPrefix = 'ls_replication_repl_lsc_item_variant_registration';

    public function _construct()
    {
        $this->_init('Ls\Replication\Model\ResourceModel\ReplLscItemVariantRegistration');
    }
