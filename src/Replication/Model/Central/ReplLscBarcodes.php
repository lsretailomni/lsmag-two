...
class ReplLscBarcodes extends \Ls\Omni\Client\CentralEcommerce\Entity\LSCBarcodes implements ReplLscBarcodesInterface, IdentityInterface
{
    public const CACHE_TAG = 'ls_replication_repl_lsc_barcodes';

    protected $_cacheTag = 'ls_replication_repl_lsc_barcodes';

    protected $_eventPrefix = 'ls_replication_repl_lsc_barcodes';

    public function _construct()
    {
        $this->_init('Ls\Replication\Model\ResourceModel\ReplLscBarcodes');
    }
