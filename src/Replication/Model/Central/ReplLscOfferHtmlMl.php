...
class ReplLscOfferHtmlMl extends \Ls\Omni\Client\CentralEcommerce\Entity\LSCOfferHTMLML implements ReplLscOfferHtmlMlInterface, IdentityInterface
{
    public const CACHE_TAG = 'ls_replication_repl_lsc_offer_html_ml';

    protected $_cacheTag = 'ls_replication_repl_lsc_offer_html_ml';

    protected $_eventPrefix = 'ls_replication_repl_lsc_offer_html_ml';

    public function _construct()
    {
        $this->_init('Ls\Replication\Model\ResourceModel\ReplLscOfferHtmlMl');
    }
