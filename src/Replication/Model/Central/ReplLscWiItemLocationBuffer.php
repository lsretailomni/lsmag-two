...
class ReplLscWiItemLocationBuffer extends \Ls\Omni\Client\CentralEcommerce\Entity\LSCWIItemLocationBuffer implements ReplLscWiItemLocationBufferInterface, IdentityInterface
{
    public const CACHE_TAG = 'ls_replication_repl_lsc_wi_item_location_buffer';

    protected $_cacheTag = 'ls_replication_repl_lsc_wi_item_location_buffer';

    protected $_eventPrefix = 'ls_replication_repl_lsc_wi_item_location_buffer';

    public function _construct()
    {
        $this->_init('Ls\Replication\Model\ResourceModel\ReplLscWiItemLocationBuffer');
    }
