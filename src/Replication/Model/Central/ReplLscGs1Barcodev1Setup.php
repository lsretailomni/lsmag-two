...
class ReplLscGs1Barcodev1Setup extends \Ls\Omni\Client\CentralEcommerce\Entity\LSCGS1BarcodeV1Setup implements ReplLscGs1Barcodev1SetupInterface, IdentityInterface
{
    public const CACHE_TAG = 'ls_replication_repl_lsc_gs_1_barcodev_1_setup';

    protected $_cacheTag = 'ls_replication_repl_lsc_gs_1_barcodev_1_setup';

    protected $_eventPrefix = 'ls_replication_repl_lsc_gs_1_barcodev_1_setup';

    public function _construct()
    {
        $this->_init('Ls\Replication\Model\ResourceModel\ReplLscGs1Barcodev1Setup');
    }
