...
class ReplHierarchyview extends \Ls\Omni\Client\CentralEcommerce\Entity\HierarchyView implements ReplHierarchyviewInterface, IdentityInterface
{
    public const CACHE_TAG = 'ls_replication_repl_hierarchyview';

    protected $_cacheTag = 'ls_replication_repl_hierarchyview';

    protected $_eventPrefix = 'ls_replication_repl_hierarchyview';

    public function _construct()
    {
        $this->_init('Ls\Replication\Model\ResourceModel\ReplHierarchyview');
    }
