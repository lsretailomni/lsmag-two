...
class ReplLscBarcodeMask extends \Ls\Omni\Client\CentralEcommerce\Entity\LSCBarcodeMask implements ReplLscBarcodeMaskInterface, IdentityInterface
{
    public const CACHE_TAG = 'ls_replication_repl_lsc_barcode_mask';

    protected $_cacheTag = 'ls_replication_repl_lsc_barcode_mask';

    protected $_eventPrefix = 'ls_replication_repl_lsc_barcode_mask';

    public function _construct()
    {
        $this->_init('Ls\Replication\Model\ResourceModel\ReplLscBarcodeMask');
    }
