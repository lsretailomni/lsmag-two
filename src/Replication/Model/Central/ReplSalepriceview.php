...
class ReplSalepriceview extends \Ls\Omni\Client\CentralEcommerce\Entity\SalePriceView implements ReplSalepriceviewInterface, IdentityInterface
{
    public const CACHE_TAG = 'ls_replication_repl_salepriceview';

    protected $_cacheTag = 'ls_replication_repl_salepriceview';

    protected $_eventPrefix = 'ls_replication_repl_salepriceview';

    public function _construct()
    {
        $this->_init('Ls\Replication\Model\ResourceModel\ReplSalepriceview');
    }
