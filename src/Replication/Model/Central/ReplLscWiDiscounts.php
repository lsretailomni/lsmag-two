...
class ReplLscWiDiscounts extends \Ls\Omni\Client\CentralEcommerce\Entity\LSCWIDiscounts implements ReplLscWiDiscountsInterface, IdentityInterface
{
    public const CACHE_TAG = 'ls_replication_repl_lsc_wi_discounts';

    protected $_cacheTag = 'ls_replication_repl_lsc_wi_discounts';

    protected $_eventPrefix = 'ls_replication_repl_lsc_wi_discounts';

    public function _construct()
    {
        $this->_init('Ls\Replication\Model\ResourceModel\ReplLscWiDiscounts');
    }
    ...
    {
        return $this->getData(self::getDbColumnsMapping()[self::PRIORITY_NO]);
    }

    public function setPriorityNo(?int $value)
    {
        return $this->setData(self::getDbColumnsMapping()[self::PRIORITY_NO], $value);
    }
