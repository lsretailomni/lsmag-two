...
class ReplHierarchynodesview extends \Ls\Omni\Client\CentralEcommerce\Entity\HierarchyNodesView implements ReplHierarchynodesviewInterface, IdentityInterface
{
    public const CACHE_TAG = 'ls_replication_repl_hierarchynodesview';

    protected $_cacheTag = 'ls_replication_repl_hierarchynodesview';

    protected $_eventPrefix = 'ls_replication_repl_hierarchynodesview';

    public function _construct()
    {
        $this->_init('Ls\Replication\Model\ResourceModel\ReplHierarchynodesview');
    }
