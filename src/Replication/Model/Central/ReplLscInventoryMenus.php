...
class ReplLscInventoryMenus extends \Ls\Omni\Client\CentralEcommerce\Entity\LSCInventoryMenus implements ReplLscInventoryMenusInterface, IdentityInterface
{
    public const CACHE_TAG = 'ls_replication_repl_lsc_inventory_menus';

    protected $_cacheTag = 'ls_replication_repl_lsc_inventory_menus';

    protected $_eventPrefix = 'ls_replication_repl_lsc_inventory_menus';

    public function _construct()
    {
        $this->_init('Ls\Replication\Model\ResourceModel\ReplLscInventoryMenus');
    }
    ...
    {
        return $this->getData(self::getDbColumnsMapping()[self::MAIN_MENU]);
    }

    public function setMainMenu(?bool $value)
    {
        return $this->setData(self::getDbColumnsMapping()[self::MAIN_MENU], $value);
    }
