...
class ReplLscWiItemModifier extends \Ls\Omni\Client\CentralEcommerce\Entity\LSCWIItemModifier implements ReplLscWiItemModifierInterface, IdentityInterface
{
    public const CACHE_TAG = 'ls_replication_repl_lsc_wi_item_modifier';

    protected $_cacheTag = 'ls_replication_repl_lsc_wi_item_modifier';

    protected $_eventPrefix = 'ls_replication_repl_lsc_wi_item_modifier';

    public function _construct()
    {
        $this->_init('Ls\Replication\Model\ResourceModel\ReplLscWiItemModifier');
    }
