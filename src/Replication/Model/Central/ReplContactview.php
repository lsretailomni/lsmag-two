...
class ReplContactview extends \Ls\Omni\Client\CentralEcommerce\Entity\ContactView implements ReplContactviewInterface, IdentityInterface
{
    public const CACHE_TAG = 'ls_replication_repl_contactview';

    protected $_cacheTag = 'ls_replication_repl_contactview';

    protected $_eventPrefix = 'ls_replication_repl_contactview';

    public function _construct()
    {
        $this->_init('Ls\Replication\Model\ResourceModel\ReplContactview');
    }
    ...
    {
        return $this->setData(self::getDbColumnsMapping()[self::CUSTOMERID], $value);
    }
