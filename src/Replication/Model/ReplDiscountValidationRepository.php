...
class ReplDiscountValidationRepository implements ReplDiscountValidationRepositoryInterface
{
    ...
    /**
     * @property ReplDiscountValidationSearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplDiscountValidationFactory $object_factory, CollectionFactory $collection_factory, ReplDiscountValidationSearchResultsFactory $result_factory)
    {
    ...
    public function save(ReplDiscountValidationInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ReplDiscountValidationInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
