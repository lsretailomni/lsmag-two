...
class ReplCustomerRepository implements ReplCustomerRepositoryInterface
{
    ...
    /**
     * @property ReplCustomerSearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplCustomerFactory $object_factory, CollectionFactory $collection_factory, ReplCustomerSearchResultsFactory $result_factory)
    {
