...
class ReplHierarchyRepository implements ReplHierarchyRepositoryInterface
{
    /**
     * @property ReplHierarchyFactory $object_factory
     */
    ...
    /**
     * @property ReplHierarchySearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplHierarchyFactory $object_factory, CollectionFactory $collection_factory, ReplHierarchySearchResultsFactory $result_factory)
    {
    ...
    public function save(ReplHierarchyInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ReplHierarchyInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
