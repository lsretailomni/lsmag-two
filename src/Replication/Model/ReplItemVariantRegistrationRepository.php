...
class ReplItemVariantRegistrationRepository implements ReplItemVariantRegistrationRepositoryInterface
{
    ...
    /**
     * @property ReplItemVariantRegistrationSearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplItemVariantRegistrationFactory $object_factory, CollectionFactory $collection_factory, ReplItemVariantRegistrationSearchResultsFactory $result_factory)
    {
    ...
    public function save(ReplItemVariantRegistrationInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ReplItemVariantRegistrationInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
