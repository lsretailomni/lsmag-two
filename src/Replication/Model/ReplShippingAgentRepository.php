...
class ReplShippingAgentRepository implements ReplShippingAgentRepositoryInterface
{
    ...
    /**
     * @property ReplShippingAgentSearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplShippingAgentFactory $object_factory, CollectionFactory $collection_factory, ReplShippingAgentSearchResultsFactory $result_factory)
    {
    ...
    public function save(ReplShippingAgentInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ReplShippingAgentInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
