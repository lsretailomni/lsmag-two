...
class ReplHierarchyNodeRepository implements ReplHierarchyNodeRepositoryInterface
{
    ...
    /**
     * @property ReplHierarchyNodeSearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplHierarchyNodeFactory $object_factory, CollectionFactory $collection_factory, ReplHierarchyNodeSearchResultsFactory $result_factory)
    {
    ...
    public function save(ReplHierarchyNodeInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ReplHierarchyNodeInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
