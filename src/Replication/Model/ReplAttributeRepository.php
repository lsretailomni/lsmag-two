...
class ReplAttributeRepository implements ReplAttributeRepositoryInterface
{
    ...
    /**
     * @property ReplAttributeSearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplAttributeFactory $object_factory, CollectionFactory $collection_factory, ReplAttributeSearchResultsFactory $result_factory)
    {
    ...
    public function save(ReplAttributeInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ReplAttributeInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
