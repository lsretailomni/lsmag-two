...
class ReplDiscountRepository implements ReplDiscountRepositoryInterface
{

    /**
     * @property ReplDiscountFactory $object_factory
     */
    ...
    /**
     * @property ReplDiscountSearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplDiscountFactory $object_factory, CollectionFactory $collection_factory, ReplDiscountSearchResultsFactory $result_factory)
    {
    ...
    public function save(ReplDiscountInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ReplDiscountInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
