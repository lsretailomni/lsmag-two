...
class ReplCurrencyExchRateRepository implements ReplCurrencyExchRateRepositoryInterface
{
    ...
    /**
     * @property ReplCurrencyExchRateSearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplCurrencyExchRateFactory $object_factory, CollectionFactory $collection_factory, ReplCurrencyExchRateSearchResultsFactory $result_factory)
    {
    ...
    public function save(ReplCurrencyExchRateInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ReplCurrencyExchRateInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
