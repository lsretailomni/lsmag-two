...
class ReplExtendedVariantValueRepository implements ReplExtendedVariantValueRepositoryInterface
{
    ...
    /**
     * @property ReplExtendedVariantValueSearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplExtendedVariantValueFactory $object_factory, CollectionFactory $collection_factory, ReplExtendedVariantValueSearchResultsFactory $result_factory)
    {
    ...
    public function save(ReplExtendedVariantValueInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ReplExtendedVariantValueInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
