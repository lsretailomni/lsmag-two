...
class ReplInvStatusRepository implements ReplInvStatusRepositoryInterface
{
    ...
    /**
     * @property ReplInvStatusSearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplInvStatusFactory $object_factory, CollectionFactory $collection_factory, ReplInvStatusSearchResultsFactory $result_factory)
    {
    ...
    public function save(ReplInvStatusInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ReplInvStatusInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
