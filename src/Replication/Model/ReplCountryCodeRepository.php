...
class ReplCountryCodeRepository implements ReplCountryCodeRepositoryInterface
{
    ...
    /**
     * @property ReplCountryCodeSearchResultsFactory $result_factory
     */
    protected $result_factory = null;

    public function __construct(ReplCountryCodeFactory $object_factory, CollectionFactory $collection_factory, ReplCountryCodeSearchResultsFactory $result_factory)
    {
    ...
    public function save(ReplCountryCodeInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ReplCountryCodeInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
