...
class ReplHierarchyHospDealLine extends AbstractModel implements ReplHierarchyHospDealLineInterface, IdentityInterface
{
    ...
    {
        $this->_init( 'Ls\Replication\Model\ResourceModel\ReplHierarchyHospDealLine' );
    }
    ...
    {
        $this->setData( 'DealLineCode', $DealLineCode );
    ...
    {
        return $this->getData( 'DealLineCode' );
    }
    ...
    {
        $this->setData( 'DealLineNo', $DealLineNo );
    ...
    {
        return $this->getData( 'DealLineNo' );
    }
