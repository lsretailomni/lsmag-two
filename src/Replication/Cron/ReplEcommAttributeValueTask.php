...
use Ls\Replication\Api\ReplAttributeValueRepositoryInterface as ReplAttributeValueRepository;
...
class ReplEcommAttributeValueTask extends AbstractReplicationTask
{
    ...
    public const CONFIG_PATH_STATUS = 'ls_mag/replication/status_repl_attribute_value';

    public const CONFIG_PATH_LAST_EXECUTE = 'ls_mag/replication/last_execute_repl_attribute_value';

    public const CONFIG_PATH_MAX_KEY = 'ls_mag/replication/max_key_repl_attribute_value';

    public const CONFIG_PATH_APP_ID = 'ls_mag/replication/app_id_repl_attribute_value';
    ...
    /**
     * @property ReplAttributeValueInterface $data_interface
     */
    ...
    /**
     * @param ReplAttributeValueInterface $data_interface
     * @return $this
     */
    ...
    /**
     * @return ReplAttributeValueInterface
     */
    ...
    public function __construct(ScopeConfigInterface $scope_config, Config $resource_config, Logger $logger, LsHelper $helper, ReplicationHelper $repHelper, ReplAttributeValueFactory $factory, ReplAttributeValueRepository $repository, ReplAttributeValueInterface $data_interface)
    {
