...
class ReplEcommAttributeValueTask extends AbstractReplicationTask
{
    ...
    const CONFIG_PATH_LAST_EXECUTE = 'ls_mag/replication/last_execute_repl_attribute_value';

    const CONFIG_PATH_MAX_KEY = 'ls_mag/replication/max_key_repl_attribute_value';
