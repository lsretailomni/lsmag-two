...
use Ls\Omni\Client\Ecommerce\Operation\ReplEcommCustomer;
...
class ReplEcommCustomerTask extends AbstractReplicationTask
{
    ...
    {
        $request = new ReplEcommCustomer($baseUrl);
