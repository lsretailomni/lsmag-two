...
use Ls\Omni\Client\Ecommerce\Operation\LSCWIPrice;
...
class ReplLscWiPriceTask extends AbstractReplicationTask
{
    ...
    public const CONFIG_PATH_MAX_KEY = 'ls_mag/replication/max_key_repl_lsc_wi_price';

    public const CONFIG_PATH_APP_ID = 'ls_mag/replication/app_id_repl_lsc_wi_price';
