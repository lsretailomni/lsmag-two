...
use Ls\Replication\Model\ReplItemCategory;

class ReplEcommItemCategoriesTask extends AbstractReplicationTask
{

    const JOB_CODE = 'replication_repl_item_category';

    const CONFIG_PATH = 'ls_mag/replication/repl_item_category';
    ...
    public function __construct(ScopeConfigInterface $scope_config, Config $resource_config, LoggerInterface $logger, LsHelper $helper, ReplItemCategoryFactory $factory, ReplItemCategoryRepository $repository)
    {
