...
class ReplEcommItemCategoriesTask extends AbstractReplicationTask
{
    ...
    public function __construct(ScopeConfigInterface $scope_config, Config $resource_config, LoggerInterface $logger, LsHelper $helper, ReplicationHelper $repHelper, ReplItemCategoryFactory $factory, ReplItemCategoryRepository $repository, ReplItemCategoryInterface $data_interface)
    {
