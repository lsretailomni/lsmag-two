...
use Ls\Omni\Client\Ecommerce\Operation\LSCAttributeOptionValue;
...
class ReplLscAttributeOptionValueTask extends AbstractReplicationTask
{
    ...
    public const CONFIG_PATH_MAX_KEY = 'ls_mag/replication/max_key_repl_lsc_attribute_option_value';

    public const CONFIG_PATH_APP_ID = 'ls_mag/replication/app_id_repl_lsc_attribute_option_value';
