...
use Ls\Replication\Model\ReplShippingAgent;
...
class ReplEcommShippingAgentTask extends AbstractReplicationTask
{
    ...
    public function __construct(ScopeConfigInterface $scope_config, Config $resource_config, LoggerInterface $logger, LsHelper $helper, ReplShippingAgentFactory $factory, ReplShippingAgentRepository $repository)
    {
    ...
    {
        return ReplShippingAgent::class;
    }
