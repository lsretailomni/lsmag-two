...
class ReplEcommAttributeOptionValueTask extends AbstractReplicationTask
{
    ...
    public function __construct(ScopeConfigInterface $scope_config, Config $resource_config, LoggerInterface $logger, LsHelper $helper, ReplicationHelper $repHelper, ReplAttributeOptionValueFactory $factory, ReplAttributeOptionValueRepository $repository, ReplAttributeOptionValueInterface $data_interface)
    {
