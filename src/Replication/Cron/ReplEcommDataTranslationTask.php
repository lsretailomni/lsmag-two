...
class ReplEcommDataTranslationTask extends AbstractReplicationTask
{
    ...
    const CONFIG_PATH_LAST_EXECUTE = 'ls_mag/replication/last_execute_repl_data_translation';
    ...
    public function __construct(ScopeConfigInterface $scope_config, Config $resource_config, LoggerInterface $logger, LsHelper $helper, ReplicationHelper $repHelper, ReplDataTranslationFactory $factory, ReplDataTranslationRepository $repository, ReplDataTranslationInterface $data_interface)
    {
    ...
    {
        $request = new ReplEcommDataTranslation($baseUrl);
