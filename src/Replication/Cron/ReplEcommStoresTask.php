...
class ReplEcommStoresTask extends AbstractReplicationTask
{
    ...
    public function __construct(ScopeConfigInterface $scope_config, Config $resource_config, LoggerInterface $logger, LsHelper $helper, ReplicationHelper $repHelper, ReplStoreFactory $factory, ReplStoreRepository $repository, ReplStoreInterface $data_interface)
    {
