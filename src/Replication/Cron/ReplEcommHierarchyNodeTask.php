...
class ReplEcommHierarchyNodeTask extends AbstractReplicationTask
{
    ...
    public const CONFIG_PATH = 'ls_mag/replication/repl_hierarchy_node';

    public const CONFIG_PATH_STATUS = 'ls_mag/replication/status_repl_hierarchy_node';

    public const CONFIG_PATH_LAST_EXECUTE = 'ls_mag/replication/last_execute_repl_hierarchy_node';

    public const CONFIG_PATH_MAX_KEY = 'ls_mag/replication/max_key_repl_hierarchy_node';

    public const CONFIG_PATH_APP_ID = 'ls_mag/replication/app_id_repl_hierarchy_node';
    ...
    public function __construct(ScopeConfigInterface $scope_config, Config $resource_config, Logger $logger, LsHelper $helper, ReplicationHelper $repHelper, ReplHierarchyNodeFactory $factory, ReplHierarchyNodeRepository $repository, ReplHierarchyNodeInterface $data_interface)
    {
