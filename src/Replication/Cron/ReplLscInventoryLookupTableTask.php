...
use Ls\Omni\Client\Ecommerce\Operation\LSCInventoryLookupTable;
...
class ReplLscInventoryLookupTableTask extends AbstractReplicationTask
{
    ...
    public const CONFIG_PATH_MAX_KEY = 'ls_mag/replication/max_key_repl_lsc_inventory_lookup_table';

    public const CONFIG_PATH_APP_ID = 'ls_mag/replication/app_id_repl_lsc_inventory_lookup_table';
