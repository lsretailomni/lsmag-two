...
class ReplLscHierarchyviewTask extends ReplEcommHierarchyTask
{
    ...
    public const MODEL_CLASS = 'Ls\\Replication\\Model\\Central\\ReplHierarchyview';
    ...
    {
        $request = new \Ls\Omni\Client\CentralEcommerce\Operation\HierarchyView($baseUrl, $connectionParams, $companyName);
