...
class ReplEcommHierarchyHospRecipeTask extends AbstractReplicationTask
{
    ...
    const JOB_CODE = 'replication_repl_hierarchy_hosp_recipe';

    const CONFIG_PATH = 'ls_mag/replication/repl_hierarchy_hosp_recipe';

    const CONFIG_PATH_STATUS = 'ls_mag/replication/status_repl_hierarchy_hosp_recipe';

    const CONFIG_PATH_LAST_EXECUTE = 'ls_mag/replication/last_execute_repl_hierarchy_hosp_recipe';

    const CONFIG_PATH_MAX_KEY = 'ls_mag/replication/max_key_repl_hierarchy_hosp_recipe';
