...
use Ls\Replication\Api\Central\ReplItemCategoryRepositoryInterface as ReplItemCategoryRepository;
use Ls\Replication\Model\Central\ReplItemCategoryFactory;
use Ls\Replication\Api\Central\Data\ReplItemCategoryInterface;

class ReplLscItemCategoryTask extends AbstractReplicationTask
{
    ...
    public const MODEL_CLASS = 'Ls\\Replication\\Model\\Central\\ReplItemCategory';
    ...
    {
        $request = new \Ls\Omni\Client\CentralEcommerce\Operation\ItemCategory($baseUrl, $connectionParams, $companyName);
