...
class ReplEcommBarcodesTask extends AbstractReplicationTask
{
    ...
    public function __construct(ScopeConfigInterface $scope_config, Config $resource_config, LoggerInterface $logger, LsHelper $helper, ReplBarcodeFactory $factory, ReplBarcodeRepository $repository)
    {
