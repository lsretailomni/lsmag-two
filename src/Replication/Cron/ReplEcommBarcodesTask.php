...
class ReplEcommBarcodesTask extends AbstractReplicationTask
{
    ...
    public const CONFIG_PATH_STATUS = 'ls_mag/replication/status_repl_barcode';

    public const CONFIG_PATH_LAST_EXECUTE = 'ls_mag/replication/last_execute_repl_barcode';

    public const CONFIG_PATH_MAX_KEY = 'ls_mag/replication/max_key_repl_barcode';

    public const CONFIG_PATH_APP_ID = 'ls_mag/replication/app_id_repl_barcode';
