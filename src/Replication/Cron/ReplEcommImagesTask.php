...
use Ls\Replication\Model\ReplImage;
...
class ReplEcommImagesTask extends AbstractReplicationTask
{
    ...
    public function __construct(ScopeConfigInterface $scope_config, Config $resource_config, LoggerInterface $logger, LsHelper $helper, ReplImageFactory $factory, ReplImageRepository $repository)
    {
