...
class ReplEcommCountryCodeTask extends AbstractReplicationTask
{
    ...
    public function __construct(ScopeConfigInterface $scope_config, Config $resource_config, LoggerInterface $logger, LsHelper $helper, ReplicationHelper $repHelper, ReplCountryCodeFactory $factory, ReplCountryCodeRepository $repository, ReplCountryCodeInterface $data_interface)
    {
