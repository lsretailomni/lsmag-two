...
class ReplEcommMemberTask extends AbstractReplicationTask
{
    ...
    public function __construct(ScopeConfigInterface $scope_config, Config $resource_config, LoggerInterface $logger, LsHelper $helper, ReplicationHelper $repHelper, ReplCustomerFactory $factory, ReplCustomerRepository $repository, ReplCustomerInterface $data_interface)
    {
