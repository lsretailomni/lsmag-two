...
use Ls\Omni\Client\Ecommerce\Operation\ReplEcommHtmlTranslation;
...
abstract class ReplEcommHtmlTranslationTask extends AbstractReplicationTask
{
    public const JOB_CODE = 'replication_repl_html_translation';

    public const CONFIG_PATH = 'ls_mag/replication/repl_html_translation';

    public const CONFIG_PATH_STATUS = 'ls_mag/replication/status_repl_html_translation';

    public const CONFIG_PATH_LAST_EXECUTE = 'ls_mag/replication/last_execute_repl_html_translation';

    public const CONFIG_PATH_MAX_KEY = 'ls_mag/replication/max_key_repl_html_translation';

    public const CONFIG_PATH_APP_ID = 'ls_mag/replication/app_id_repl_html_translation';
