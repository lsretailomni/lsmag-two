...
class ReplEcommImageLinksTask extends AbstractReplicationTask
{
    ...
    const CONFIG_PATH_LAST_EXECUTE = 'ls_mag/replication/last_execute_repl_image_link';
    ...
    public function __construct(ScopeConfigInterface $scope_config, Config $resource_config, LoggerInterface $logger, LsHelper $helper, ReplicationHelper $repHelper, ReplImageLinkFactory $factory, ReplImageLinkRepository $repository, ReplImageLinkInterface $data_interface)
    {
