...
class ReplEcommBasePricesTask extends AbstractReplicationTask
{
    ...
    public function __construct(ScopeConfigInterface $scope_config, Config $resource_config, LoggerInterface $logger, LsHelper $helper, ReplicationHelper $repHelper, ReplPriceFactory $factory, ReplPriceRepository $repository, ReplPriceInterface $data_interface)
    {
