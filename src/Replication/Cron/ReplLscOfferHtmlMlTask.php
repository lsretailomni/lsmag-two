...
class ReplLscOfferHtmlMlTask extends ReplEcommDealHtmlTranslationTask
{
    public const CONFIG_PATH_LAST_ENTRY_NO = 'ls_mag/replication/last_entry_no_repl_deal_html_translation';
