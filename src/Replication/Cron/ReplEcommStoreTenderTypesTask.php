...
abstract class ReplEcommStoreTenderTypesTask extends AbstractReplicationTask
{
    ...
    public const CONFIG_PATH_APP_ID = 'ls_mag/replication/app_id_repl_store_tender_type';
