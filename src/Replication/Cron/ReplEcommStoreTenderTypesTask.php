...
class ReplEcommStoreTenderTypesTask extends AbstractReplicationTask
{
    ...
    const CONFIG_PATH_LAST_EXECUTE = 'ls_mag/replication/last_execute_repl_store_tender_type';
    ...
    public function __construct(ScopeConfigInterface $scope_config, Config $resource_config, LoggerInterface $logger, LsHelper $helper, ReplicationHelper $repHelper, ReplStoreTenderTypeFactory $factory, ReplStoreTenderTypeRepository $repository, ReplStoreTenderTypeInterface $data_interface)
    {
