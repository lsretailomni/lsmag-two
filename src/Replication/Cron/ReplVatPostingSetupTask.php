...
use Ls\Omni\Client\Ecommerce\Operation\VATPostingSetup;
...
class ReplVatPostingSetupTask extends AbstractReplicationTask
{
    ...
    public const CONFIG_PATH_MAX_KEY = 'ls_mag/replication/max_key_repl_vat_posting_setup';

    public const CONFIG_PATH_APP_ID = 'ls_mag/replication/app_id_repl_vat_posting_setup';
