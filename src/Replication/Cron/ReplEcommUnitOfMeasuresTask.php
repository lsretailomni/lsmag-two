...
class ReplEcommUnitOfMeasuresTask extends AbstractReplicationTask
{
    ...
    public function __construct(ScopeConfigInterface $scope_config, Config $resource_config, LoggerInterface $logger, LsHelper $helper, ReplicationHelper $repHelper, ReplUnitOfMeasureFactory $factory, ReplUnitOfMeasureRepository $repository, ReplUnitOfMeasureInterface $data_interface)
    {
