...
class ModelGenerator extends AbstractGenerator
{
    ...
    public function generate () {
        ...
        $this->class->addProperty( '_cacheTag', 'ls_replication_' . $this->operation->getTableName(),
                                   PropertyGenerator::FLAG_PROTECTED );
        $this->class->addProperty( '_eventPrefix', 'ls_replication_' . $this->operation->getTableName(),
                                   PropertyGenerator::FLAG_PROTECTED );
