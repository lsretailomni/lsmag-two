...
if (!defined('TENDER_TYPE_MAPPINGS')) { define('TENDER_TYPE_MAPPINGS', getenv('TENDER_TYPE_MAPPINGS') ? json_decode(getenv('TENDER_TYPE_MAPPINGS'), true) : ''); }
if (!defined('ADYEN_RESPONSE')) { define('ADYEN_RESPONSE', getenv('ADYEN_RESPONSE') ? json_decode(getenv('ADYEN_RESPONSE'), true) : ''); }
