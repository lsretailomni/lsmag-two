...
/**
 * Data patch to create item product group attribute
 */
class CreateLsProductGroupAttribute implements DataPatchInterface
{
    /**
    ...
    private function createRequiredProductAttribute()
    {
        ...
        $eavSetup->addAttribute(
            ...
            [
                'type'                    => 'varchar',
                'label'                   => LSR::LS_ITEM_PRODUCT_GROUP_LABEL,
                'input'                   => 'text',
                'sort_order'              => 5,
