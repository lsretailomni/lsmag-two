...
class RequestTest extends AbstractBackendController
{
    ...
    #[
        ...
        Config(LSR::LS_ORDER_NUMBER_PREFIX_PATH, AbstractIntegrationTest::LS_ORDER_NUMBER_PREFIX_PATH,  'store', 'default'),
        Config(LSR::LS_ORDER_NUMBER_PREFIX_PATH, AbstractIntegrationTest::LS_ORDER_NUMBER_PREFIX_PATH,  'website'),
        DataFixture(
