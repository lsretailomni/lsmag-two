...
use \Ls\Omni\Controller\Ajax\UpdatePoints;
...
class UpdatePointsTest extends AbstractController
{
    /**
    ...
    protected function setUp(): void
    {
        ...
        $this->updatePoints    = $this->objectManager->get(UpdatePoints::class);
    ...
    {
        $loyData = [
            'loyaltyPoints' => AbstractIntegrationTest::LOY_POINTS
        ];
        $content = json_encode($loyData);
        ...
        $this->dispatch('omni/ajax/updatePoints');
    ...
    public function testExecuteNoLsrId()
    {
        $loyData = [
            'loyaltyPoints' => AbstractIntegrationTest::LOY_POINTS
        ];
