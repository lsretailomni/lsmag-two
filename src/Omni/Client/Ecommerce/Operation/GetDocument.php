...
use Ls\Omni\Client\Ecommerce\Entity\GetDocument as GetDocumentRequest;
use Ls\Omni\Client\Ecommerce\Entity\GetDocumentResult as GetDocumentResponse;
...
/** @noinspection PhpDocSignatureInspection */
     ...
     * @return ResponseInterface|GetDocumentResponse
     */
    ...
    public function & getOperationInput()
    {
        if ( is_null( $this->request ) ) {
            $this->request = new GetDocumentRequest();
        }
        return $this->request;
    }
