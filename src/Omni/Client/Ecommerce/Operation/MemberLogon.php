...
use Ls\Omni\Client\Ecommerce\Entity\MemberLogon as MemberLogonRequest;
use Ls\Omni\Client\Ecommerce\Entity\MemberLogonResult as MemberLogonResponse;

class MemberLogon extends AbstractOperation
{
    public const OPERATION_NAME = 'MemberLogon';
...
/** @noinspection PhpDocSignatureInspection */
    /**
     * @param MemberLogonRequest $request
     * @return ResponseInterface|MemberLogonResponse
     */
    ...
    /**
     * @return MemberLogonRequest
     */
    public function & getOperationInput()
    {
        if ( is_null( $this->request ) ) {
            $this->request = new MemberLogonRequest();
        }
        return $this->request;
    }
    ...
    public function setRequest(\MemberLogonRequest $request)
    {
        $this->setData('request', $request);
        return $this;
    }

    public function getRequest() : \MemberLogonRequest
    {
        return $this->request;
    }

    public function setResponse(\MemberLogonResponse $response)
    {
        $this->setData('response', $response);
        return $this;
    }

    public function getResponse() : \MemberLogonResponse
    {
