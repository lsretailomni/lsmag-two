...
use Ls\Omni\Client\Ecommerce\Entity\OpenGate as OpenGateRequest;
use Ls\Omni\Client\Ecommerce\Entity\OpenGateResponse as OpenGateResponse;
...
class OpenGate extends AbstractOperation
{
    ...
    /**
     * @property OpenGateRequest $request
     */
    protected $request = null;

    /**
     * @property OpenGateResponse $response
     */
    ...
    public function execute(RequestInterface $request = null)
    {
        ...
        return $this->makeRequest( 'OpenGate' );
    }
    ...
    /**
     * @param OpenGateResponse $response
     * @return $this
     */
