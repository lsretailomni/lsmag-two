...
class TenderView
{
    ...
    public function __construct($baseUrl = '', $connectionParams = [], $companyName = '')
    {
        ...
        $this->request = new \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetTenderTypeEx();
    }
    ...
    public function formatResponse($data): \Ls\Omni\Client\Ecommerce\Entity\TenderViewResponse
    {
        ...
        if (!empty($fields)) {
            foreach ($rows as $row) {
                $values = $row['Fields'] ?? [];
                $entry = new \Ls\Omni\Client\Ecommerce\Entity\TenderView();
        ...
        return new \Ls\Omni\Client\Ecommerce\Entity\TenderViewResponse([
            'records' => $results,
            'status' => $data['Status'] ?? '',
    ...
    {
        $this->setRequest(new \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetTenderTypeEx($params));
