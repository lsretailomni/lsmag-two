...
use Ls\Omni\Client\Ecommerce\Entity\TestConnection as TestConnectionRequest;
use Ls\Omni\Client\Ecommerce\Entity\TestConnectionResult as TestConnectionResponse;
...
/** @noinspection PhpDocSignatureInspection */
     ...
     * @return ResponseInterface|TestConnectionResponse
     */
    ...
    public function & getOperationInput()
    {
        if ( is_null( $this->request ) ) {
            $this->request = new TestConnectionRequest();
        }
        return $this->request;
    }
