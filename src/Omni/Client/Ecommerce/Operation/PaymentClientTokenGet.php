...
use Ls\Omni\Client\Ecommerce\Entity\PaymentClientTokenGet as PaymentClientTokenGetRequest;
use Ls\Omni\Client\Ecommerce\Entity\PaymentClientTokenGetResponse as PaymentClientTokenGetResponse;

class PaymentClientTokenGet extends AbstractOperation
{
    public const OPERATION_NAME = 'PAYMENT_CLIENT_TOKEN_GET';
    ...
    /**
     * @property PaymentClientTokenGetRequest $request
     */
    protected $request = null;

    /**
     * @property PaymentClientTokenGetResponse $response
     */
    ...
    public function execute(RequestInterface $request = null)
    {
        ...
        return $this->makeRequest( 'PaymentClientTokenGet' );
    }
    ...
    /**
     * @param PaymentClientTokenGetResponse $response
     * @return $this
     */
    ...
    /**
     * @return PaymentClientTokenGetResponse
     */
