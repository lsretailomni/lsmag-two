...
use Ls\Omni\Client\Ecommerce\Entity\GetHierarchyV2 as GetHierarchyV2Request;
use Ls\Omni\Client\Ecommerce\Entity\GetHierarchyV2Result as GetHierarchyV2Response;

class GetHierarchyV2 extends AbstractOperation
{
    public const OPERATION_NAME = 'GetHierarchyV2';
...
/** @noinspection PhpDocSignatureInspection */
    /**
     * @param GetHierarchyV2Request $request
     * @return ResponseInterface|GetHierarchyV2Response
     */
    ...
    /**
     * @return GetHierarchyV2Request
     */
    public function & getOperationInput()
    {
        if ( is_null( $this->request ) ) {
            $this->request = new GetHierarchyV2Request();
        }
        return $this->request;
    }
    ...
    public function setRequest(\GetHierarchyV2Request $request)
    {
        $this->setData('request', $request);
        return $this;
    }

    public function getRequest() : \GetHierarchyV2Request
    {
        return $this->request;
    }

    public function setResponse(\GetHierarchyV2Response $response)
    {
        $this->setData('response', $response);
        return $this;
    }

    public function getResponse() : \GetHierarchyV2Response
    {
