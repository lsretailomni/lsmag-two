...
class LSCBarcodeMaskSegment
{
    ...
    public \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetBarcodeMaskSegment $request;
    public \Ls\Omni\Client\Ecommerce\Entity\LSCBarcodeMaskSegmentResponse $response;
    ...
    public function __construct($baseUrl = '', $connectionParams = [], $companyName = '')
    {
        ...
        $this->request = $this->createInstance(\Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetBarcodeMaskSegment::class);
    }
    ...
    public function formatResponse($data): \Ls\Omni\Client\Ecommerce\Entity\LSCBarcodeMaskSegmentResponse
    {
        ...
        return $this->createInstance(
                    \Ls\Omni\Client\Ecommerce\Entity\LSCBarcodeMaskSegmentResponse::class,
                     [
                        'data' => [
                        'records' => $results,
                        'status' => $data['Status'] ?? '',
    ...
    public function & setOperationInput(array $params = []): \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetBarcodeMaskSegment
    {
        $this->setRequest(
            $this->createInstance(
                \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetBarcodeMaskSegment::class,
                ['data' => $params]
            )
        );
    ...
    public function setResponse(\Ls\Omni\Client\Ecommerce\Entity\LSCBarcodeMaskSegmentResponse $response): self
    {
        $this->response = $response;
        return $this;
    }

    public function getRequest(): \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetBarcodeMaskSegment
    {
        return $this->request;
    }

    public function getResponse(): \Ls\Omni\Client\Ecommerce\Entity\LSCBarcodeMaskSegmentResponse
    {
