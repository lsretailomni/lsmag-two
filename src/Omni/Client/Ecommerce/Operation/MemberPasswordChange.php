...
use Ls\Omni\Client\Ecommerce\Entity\MemberPasswordChange as MemberPasswordChangeRequest;
...
/** @noinspection PhpDocSignatureInspection */
     ...
     * @return ResponseInterface|MemberPasswordChangeResponse
     */
    ...
    /**
     * @return MemberPasswordChangeRequest
     */
    public function & getOperationInput()
    {
        if ( is_null( $this->request ) ) {
            $this->request = new MemberPasswordChangeRequest();
        }
        return $this->request;
    }
