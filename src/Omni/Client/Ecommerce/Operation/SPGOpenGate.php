...
use Ls\Omni\Client\Ecommerce\Entity\SPGOpenGate as SPGOpenGateRequest;
use Ls\Omni\Client\Ecommerce\Entity\SPGOpenGateResult as SPGOpenGateResponse;

class SPGOpenGate extends AbstractOperation
{
    public const OPERATION_NAME = 'SPGOpenGate';
...
/** @noinspection PhpDocSignatureInspection */
    /**
     * @param SPGOpenGateRequest $request
     * @return ResponseInterface|SPGOpenGateResponse
     */
    ...
    /**
     * @return SPGOpenGateRequest
     */
    public function & getOperationInput()
    {
        if ( is_null( $this->request ) ) {
            $this->request = new SPGOpenGateRequest();
        }
        return $this->request;
    }
    ...
    public function setRequest(\SPGOpenGateRequest $request)
    {
        $this->setData('request', $request);
        return $this;
    }

    public function getRequest() : \SPGOpenGateRequest
    {
        return $this->request;
    }

    public function setResponse(\SPGOpenGateResponse $response)
    {
        $this->setData('response', $response);
        return $this;
    }

    public function getResponse() : \SPGOpenGateResponse
    {
