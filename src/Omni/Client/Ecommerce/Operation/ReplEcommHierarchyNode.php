...
use Ls\Omni\Client\Ecommerce\Entity\ReplEcommHierarchyNode as ReplEcommHierarchyNodeRequest;
use Ls\Omni\Client\Ecommerce\Entity\ReplEcommHierarchyNodeResponse as ReplEcommHierarchyNodeResponse;
...
class ReplEcommHierarchyNode extends AbstractOperation
{
    ...
    /**
     * @property ReplEcommHierarchyNodeRequest $request
     */
    protected $request = null;

    /**
     * @property ReplEcommHierarchyNodeResponse $response
     */
    ...
    public function execute(RequestInterface $request = null)
    {
        ...
        return $this->makeRequest( 'ReplEcommHierarchyNode' );
    }

    /**
     * @return ReplEcommHierarchyNodeRequest
     */
    public function & getOperationInput()
    {
        if ( is_null( $this->request ) ) {
            $this->request = new ReplEcommHierarchyNodeRequest();
        }
        return $this->request;
    }
    ...
    /**
     * @param ReplEcommHierarchyNodeResponse $response
     * @return $this
     */
    ...
    /**
     * @return ReplEcommHierarchyNodeResponse
     */
