...
class LSCAttributeValue
{
    ...
    public \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetAttributeValues $request;
    public \Ls\Omni\Client\Ecommerce\Entity\LSCAttributeValueResponse $response;
    ...
    public function execute(\Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetAttributeValues $request = null): \Ls\Omni\Client\Ecommerce\Entity\LSCAttributeValueResponse
    {
        if ( !is_null( $request ) ) {
        ...
        $response = $this->dataHelper->makeRequest(
            \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetAttributeValues::ACTION_NAME,
    ...
    public function formatResponse($data): \Ls\Omni\Client\Ecommerce\Entity\LSCAttributeValueResponse
    {
    ...
    public function setRequest(\Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetAttributeValues $request): self
    {
        $this->request = $request;
        return $this;
    }

    public function setResponse(\Ls\Omni\Client\Ecommerce\Entity\LSCAttributeValueResponse $response): self
    {
        $this->response = $response;
        return $this;
    }

    public function getRequest(): \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetAttributeValues
    {
        return $this->request;
    }

    public function getResponse(): \Ls\Omni\Client\Ecommerce\Entity\LSCAttributeValueResponse
    {
