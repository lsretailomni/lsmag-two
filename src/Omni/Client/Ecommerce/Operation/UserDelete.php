...
use Ls\Omni\Client\Ecommerce\Entity\UserDelete as UserDeleteRequest;
use Ls\Omni\Client\Ecommerce\Entity\UserDeleteResponse as UserDeleteResponse;

class UserDelete extends AbstractOperation
{

    const OPERATION_NAME = 'USER_DELETE';
    ...
    /**
     * @property UserDeleteRequest $request
     */
    protected $request = null;

    /**
     * @property UserDeleteResponse $response
     */
     ...
     * @return ResponseInterface|UserDeleteResponse
     */
    public function execute(RequestInterface $request = null)
    {
        ...
        return $this->makeRequest( 'UserDelete' );
    }
