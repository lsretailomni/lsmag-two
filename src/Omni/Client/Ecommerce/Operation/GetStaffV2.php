...
/** @noinspection PhpDocSignatureInspection */
    ...
    public function setRequest(\GetStaffV2Request $request)
    {
        $this->setData('request', $request);
        return $this;
    }

    public function getRequest() : \GetStaffV2Request
    {
        return $this->request;
    }

    public function setResponse(\GetStaffV2Response $response)
    {
        $this->setData('response', $response);
        return $this;
    }

    public function getResponse() : \GetStaffV2Response
    {
