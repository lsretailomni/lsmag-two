...
use Ls\Omni\Client\Ecommerce\Entity\OneListGetById as OneListGetByIdRequest;
use Ls\Omni\Client\Ecommerce\Entity\OneListGetByIdResponse as OneListGetByIdResponse;

class OneListGetById extends AbstractOperation
{

    public const OPERATION_NAME = 'ONE_LIST_GET_BY_ID';
