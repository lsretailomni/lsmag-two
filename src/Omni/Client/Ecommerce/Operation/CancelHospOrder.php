...
use Ls\Omni\Client\Ecommerce\Entity\CancelHospOrderResult as CancelHospOrderResponse;

class CancelHospOrder extends AbstractOperation
{
    public const OPERATION_NAME = 'CancelHospOrder';
...
/** @noinspection PhpDocSignatureInspection */
    /**
     * @param CancelHospOrderRequest $request
     * @return ResponseInterface|CancelHospOrderResponse
     */
    ...
    /**
     * @return CancelHospOrderRequest
     */
    public function & getOperationInput()
    {
        if ( is_null( $this->request ) ) {
            $this->request = new CancelHospOrderRequest();
        }
        return $this->request;
    }
    ...
    public function setRequest(\CancelHospOrderRequest $request)
    {
        $this->setData('request', $request);
        return $this;
    }

    public function getRequest() : \CancelHospOrderRequest
    {
        return $this->request;
    }

    public function setResponse(\CancelHospOrderResponse $response)
    {
        $this->setData('response', $response);
        return $this;
    }

    public function getResponse() : \CancelHospOrderResponse
    {
