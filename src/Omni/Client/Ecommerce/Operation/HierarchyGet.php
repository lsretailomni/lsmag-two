...
use Ls\Omni\Client\Ecommerce\Entity\HierarchyGet as HierarchyGetRequest;
use Ls\Omni\Client\Ecommerce\Entity\HierarchyGetResponse as HierarchyGetResponse;
...
class HierarchyGet extends AbstractOperation
{
    ...
    /**
     * @property HierarchyGetRequest $request
     */
    protected $request = null;

    /**
     * @property HierarchyGetResponse $response
     */
    ...
    /**
     * @param HierarchyGetRequest $request
     * @return ResponseInterface|HierarchyGetResponse
     */
    public function execute(RequestInterface $request = null)
    {
        ...
        return $this->makeRequest( 'HierarchyGet' );
    }

    /**
     * @return HierarchyGetRequest
     */
    public function & getOperationInput()
    {
        if ( is_null( $this->request ) ) {
            $this->request = new HierarchyGetRequest();
        }
        return $this->request;
    }
    ...
    /**
     * @param HierarchyGetResponse $response
     * @return $this
     */
