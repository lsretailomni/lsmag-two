...
class PeriodicDiscView
{
    ...
    public function __construct($baseUrl = '', $connectionParams = [], $companyName = '')
    {
        ...
        $this->request = new \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetDiscountSetup();
    }
    ...
    public function formatResponse($data): \Ls\Omni\Client\Ecommerce\Entity\PeriodicDiscViewResponse
    {
        ...
        if (!empty($fields)) {
            foreach ($rows as $row) {
                $values = $row['Fields'] ?? [];
                $entry = new \Ls\Omni\Client\Ecommerce\Entity\PeriodicDiscView();
        ...
        return new \Ls\Omni\Client\Ecommerce\Entity\PeriodicDiscViewResponse([
            'records' => $results,
            'status' => $data['Status'] ?? '',
    ...
    {
        $this->setRequest(new \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetDiscountSetup($params));
    ...
    public function setResponse(\Ls\Omni\Client\Ecommerce\Entity\PeriodicDiscViewResponse $response): self
    {
    ...
    public function getResponse(): \Ls\Omni\Client\Ecommerce\Entity\PeriodicDiscViewResponse
    {
