...
class PeriodicDiscView
{
    ...
    public function execute(\Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetDiscountSetup $request = null): \Ls\Omni\Client\Ecommerce\Entity\PeriodicDiscViewResponse
    {
        if ( !is_null( $request ) ) {
