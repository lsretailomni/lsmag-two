...
class LSCWIExtdVariantValues
{
    ...
    public \Ls\Omni\Client\Ecommerce\Entity\LSCWIExtdVariantValuesResponse $response;
    ...
    public function __construct($baseUrl = '', $connectionParams = [], $companyName = '')
    {
        ...
        $this->request = $this->createInstance(\Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetExtdVariantValues::class);
    }

    public function execute(): \Ls\Omni\Client\Ecommerce\Entity\LSCWIExtdVariantValuesResponse
    {
        $response = $this->dataHelper->makeRequest(
            \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetExtdVariantValues::ACTION_NAME,
            \Ls\Omni\Client\Ecommerce\Entity\LSCWIExtdVariantValues::class,
            $this->request,
            $this->baseUrl,
    ...
    public function formatResponse($data): \Ls\Omni\Client\Ecommerce\Entity\LSCWIExtdVariantValuesResponse
    {
        ...
        return $this->createInstance(
                    \Ls\Omni\Client\Ecommerce\Entity\LSCWIExtdVariantValuesResponse::class,
                     [
                        'data' => [
                        'records' => $results,
                        'status' => $data['Status'] ?? '',
    ...
    public function & setOperationInput(array $params = []): \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetExtdVariantValues
    {
        $this->setRequest(
            $this->createInstance(
                \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetExtdVariantValues::class,
                ['data' => $params]
            )
        );
    ...
    public function setResponse(\Ls\Omni\Client\Ecommerce\Entity\LSCWIExtdVariantValuesResponse $response): self
    {
    ...
    public function getResponse(): \Ls\Omni\Client\Ecommerce\Entity\LSCWIExtdVariantValuesResponse
    {
