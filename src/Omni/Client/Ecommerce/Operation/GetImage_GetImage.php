...
class GetImage_GetImage
{
    ...
    public \Ls\Omni\Client\Ecommerce\Entity\GetImage_GetImageRequest $request;
    public \Ls\Omni\Client\Ecommerce\Entity\GetImage_GetImageResponse $response;
    ...
    public function __construct(string $baseUrl = '', array $connectionParams = [], string $companyName = '')
    {
        ...
        $this->request = $this->createInstance(\Ls\Omni\Client\Ecommerce\Entity\GetImage_GetImageRequest::class);
    }

    public function execute(): \Ls\Omni\Client\Ecommerce\Entity\GetImage_GetImageResponse
    {
        $raw = $this->dataHelper->makeRequest(
            \Ls\Omni\Client\Ecommerce\Entity\GetImage_GetImageRequest::ACTION_NAME,
            self::class,
            $this->request,
            $this->baseUrl,
    ...
    public function formatResponse($data): \Ls\Omni\Client\Ecommerce\Entity\GetImage_GetImageResponse
    {
        $requiredDataSetName = explode(',', 'Tenant Media');
        $finalEntry = $this->createInstance(\Ls\Omni\Client\Ecommerce\Entity\GetImage_GetImage::class);
            ...
            foreach ($requiredDataSetName as $dataSet) {
                ...
                if (isset($data[$dataSet]) && is_array($data[$dataSet])) {
                    $entity = $this->createInstance(
                        \Ls\Omni\Client\Ecommerce\Entity\GetImage_GetImage::class,
                         ['data' => $data['Tenant Media']]
                     );

                    return $this->createInstance(
                        \Ls\Omni\Client\Ecommerce\Entity\GetImage_GetImageResponse::class,
                       [
                       'data' =>
                           [
                                'records' => [$entity],
    ...
    public function & setOperationInput(array $params = []): \Ls\Omni\Client\Ecommerce\Entity\GetImage_GetImageRequest
    {
        $this->setRequest(
            $this->createInstance(
                \Ls\Omni\Client\Ecommerce\Entity\GetImage_GetImageRequest::class,
                ['data' => $params]
            )
        );
    ...
    public function setRequest(\Ls\Omni\Client\Ecommerce\Entity\GetImage_GetImageRequest $request): self
    {
        $this->request = $request;
        return $this;
    }

    public function setResponse(\Ls\Omni\Client\Ecommerce\Entity\GetImage_GetImageResponse $response): self
    {
        $this->response = $response;
        return $this;
    }

    public function getRequest(): \Ls\Omni\Client\Ecommerce\Entity\GetImage_GetImageRequest
    {
        return $this->request;
    }

    public function getResponse(): \Ls\Omni\Client\Ecommerce\Entity\GetImage_GetImageResponse
    {
