...
use Ls\Omni\Client\Ecommerce\Entity\WebRequest as WebRequestRequest;
use Ls\Omni\Client\Ecommerce\Entity\WebRequestResponse as WebRequestResponse;

class WebRequest extends AbstractOperation
{

    public const OPERATION_NAME = 'WEB_REQUEST';
    ...
    /**
     * @property WebRequestRequest $request
     */
    protected $request = null;

    /**
     * @property WebRequestResponse $response
     */
    ...
    public function execute(RequestInterface $request = null)
    {
        ...
        return $this->makeRequest( 'WebRequest' );
    }

    /**
     * @return WebRequestRequest
     */
    public function & getOperationInput()
    {
        if ( is_null( $this->request ) ) {
            $this->request = new WebRequestRequest();
        }
        return $this->request;
    }
