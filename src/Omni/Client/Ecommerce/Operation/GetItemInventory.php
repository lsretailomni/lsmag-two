...
use Ls\Omni\Client\Ecommerce\Entity\GetItemInventory as GetItemInventoryRequest;
use Ls\Omni\Client\Ecommerce\Entity\GetItemInventoryResult as GetItemInventoryResponse;

class GetItemInventory extends AbstractOperation
{
    public const OPERATION_NAME = 'GetItemInventory';
...
/** @noinspection PhpDocSignatureInspection */
    /**
     * @param GetItemInventoryRequest $request
     * @return ResponseInterface|GetItemInventoryResponse
     */
    ...
    /**
     * @return GetItemInventoryRequest
     */
    public function & getOperationInput()
    {
        if ( is_null( $this->request ) ) {
            $this->request = new GetItemInventoryRequest();
        }
        return $this->request;
    }
    ...
    public function setRequest(\GetItemInventoryRequest $request)
    {
        $this->setData('request', $request);
        return $this;
    }

    public function getRequest() : \GetItemInventoryRequest
    {
        return $this->request;
    }

    public function setResponse(\GetItemInventoryResponse $response)
    {
        $this->setData('response', $response);
        return $this;
    }

    public function getResponse() : \GetItemInventoryResponse
    {
