...
class LSCValidationPeriod
{
    ...
    public \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetValidationPeriod $request;
    public \Ls\Omni\Client\Ecommerce\Entity\LSCValidationPeriodResponse $response;
    ...
    public function __construct($baseUrl = '', $connectionParams = [], $companyName = '')
    {
        ...
        $this->request = $this->createInstance(\Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetValidationPeriod::class);
    }
    ...
    public function formatResponse($data): \Ls\Omni\Client\Ecommerce\Entity\LSCValidationPeriodResponse
    {
        ...
        return $this->createInstance(
                    \Ls\Omni\Client\Ecommerce\Entity\LSCValidationPeriodResponse::class,
                     [
                        'data' => [
                        'records' => $results,
                        'status' => $data['Status'] ?? '',
    ...
    public function & setOperationInput(array $params = []): \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetValidationPeriod
    {
        $this->setRequest(
            $this->createInstance(
                \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetValidationPeriod::class,
                ['data' => $params]
            )
        );
    ...
    public function setResponse(\Ls\Omni\Client\Ecommerce\Entity\LSCValidationPeriodResponse $response): self
    {
        $this->response = $response;
        return $this;
    }

    public function getRequest(): \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetValidationPeriod
    {
        return $this->request;
    }

    public function getResponse(): \Ls\Omni\Client\Ecommerce\Entity\LSCValidationPeriodResponse
    {
