...
use Ls\Omni\Client\Ecommerce\Entity\CurrencyGet as CurrencyGetRequest;
use Ls\Omni\Client\Ecommerce\Entity\CurrencyGetResponse as CurrencyGetResponse;

class CurrencyGet extends AbstractOperation
{
    public const OPERATION_NAME = 'CURRENCY_GET';
    ...
    /**
     * @property CurrencyGetRequest $request
     */
    protected $request = null;

    /**
     * @property CurrencyGetResponse $response
     */
    ...
    public function execute(RequestInterface $request = null)
    {
        ...
        return $this->makeRequest( 'CurrencyGet' );
    }

    /**
     * @return CurrencyGetRequest
     */
    public function & getOperationInput()
    {
        if ( is_null( $this->request ) ) {
            $this->request = new CurrencyGetRequest();
        }
        return $this->request;
    }
    ...
    /**
     * @param CurrencyGetResponse $response
     * @return $this
     */
