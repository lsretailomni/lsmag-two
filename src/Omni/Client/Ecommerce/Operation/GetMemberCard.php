...
use Ls\Omni\Client\Ecommerce\Entity\GetMemberCard as GetMemberCardRequest;
use Ls\Omni\Client\Ecommerce\Entity\GetMemberCardResult as GetMemberCardResponse;

class GetMemberCard extends AbstractOperation
{
    public const OPERATION_NAME = 'GetMemberCard';
...
/** @noinspection PhpDocSignatureInspection */
    /**
     * @param GetMemberCardRequest $request
     * @return ResponseInterface|GetMemberCardResponse
     */
    ...
    /**
     * @return GetMemberCardRequest
     */
    public function & getOperationInput()
    {
        if ( is_null( $this->request ) ) {
            $this->request = new GetMemberCardRequest();
        }
        return $this->request;
    }
    ...
    public function setRequest(\GetMemberCardRequest $request)
    {
        $this->setData('request', $request);
        return $this;
    }

    public function getRequest() : \GetMemberCardRequest
    {
        return $this->request;
    }

    public function setResponse(\GetMemberCardResponse $response)
    {
        $this->setData('response', $response);
        return $this;
    }

    public function getResponse() : \GetMemberCardResponse
    {
