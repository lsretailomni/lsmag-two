...
use Ls\Omni\Client\Ecommerce\Entity\ItemsPage as ItemsPageRequest;
use Ls\Omni\Client\Ecommerce\Entity\ItemsPageResponse as ItemsPageResponse;

class ItemsPage extends AbstractOperation
{

    public const OPERATION_NAME = 'ITEMS_PAGE';
