...
use Ls\Omni\Client\Ecommerce\Entity\GetInventoryMultiple as GetInventoryMultipleRequest;
use Ls\Omni\Client\Ecommerce\Entity\GetInventoryMultipleResult as GetInventoryMultipleResponse;

class GetInventoryMultiple extends AbstractOperation
{
    public const OPERATION_NAME = 'GetInventoryMultiple';
...
/** @noinspection PhpDocSignatureInspection */
     ...
     * @return ResponseInterface|GetInventoryMultipleResponse
     */
    ...
    public function & getOperationInput()
    {
        if ( is_null( $this->request ) ) {
            $this->request = new GetInventoryMultipleRequest();
        }
        return $this->request;
    }
