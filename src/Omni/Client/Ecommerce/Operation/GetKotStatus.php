...
use Ls\Omni\Client\Ecommerce\Entity\GetKotStatus as GetKotStatusRequest;
...
/** @noinspection PhpDocSignatureInspection */
    /**
     * @param GetKotStatusRequest $request
     * @return ResponseInterface|GetKotStatusResponse
     */
    ...
    /**
     * @return GetKotStatusRequest
     */
    public function & getOperationInput()
    {
        if ( is_null( $this->request ) ) {
            $this->request = new GetKotStatusRequest();
        }
        return $this->request;
    }
