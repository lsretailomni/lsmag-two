...
use Ls\Omni\Client\Ecommerce\Entity\MobilePosFloatEnt as MobilePosFloatEntRequest;
use Ls\Omni\Client\Ecommerce\Entity\MobilePosFloatEntResult as MobilePosFloatEntResponse;

class MobilePosFloatEnt extends AbstractOperation
{
    public const OPERATION_NAME = 'MobilePosFloatEnt';
...
/** @noinspection PhpDocSignatureInspection */
    /**
     * @param MobilePosFloatEntRequest $request
     * @return ResponseInterface|MobilePosFloatEntResponse
     */
    ...
    /**
     * @return MobilePosFloatEntRequest
     */
    public function & getOperationInput()
    {
        if ( is_null( $this->request ) ) {
            $this->request = new MobilePosFloatEntRequest();
        }
        return $this->request;
    }
    ...
    public function setRequest(\MobilePosFloatEntRequest $request)
    {
        $this->setData('request', $request);
        return $this;
    }

    public function getRequest() : \MobilePosFloatEntRequest
    {
        return $this->request;
    }

    public function setResponse(\MobilePosFloatEntResponse $response)
    {
        $this->setData('response', $response);
        return $this;
    }

    public function getResponse() : \MobilePosFloatEntResponse
    {
