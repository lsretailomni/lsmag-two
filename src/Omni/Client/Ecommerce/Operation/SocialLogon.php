...
use Ls\Omni\Client\Ecommerce\Entity\SocialLogon as SocialLogonRequest;
use Ls\Omni\Client\Ecommerce\Entity\SocialLogonResponse as SocialLogonResponse;
...
class SocialLogon extends AbstractOperation
{
    ...
    /**
     * @property SocialLogonRequest $request
     */
    protected $request = null;

    /**
     * @property SocialLogonResponse $response
     */
    ...
    /**
     * @param SocialLogonRequest $request
     * @return ResponseInterface|SocialLogonResponse
     */
    public function execute(RequestInterface $request = null)
    {
        ...
        return $this->makeRequest( 'SocialLogon' );
    }
    ...
    public function & getOperationInput()
    {
        if ( is_null( $this->request ) ) {
            $this->request = new SocialLogonRequest();
        }
        return $this->request;
    }
    ...
    /**
     * @param SocialLogonResponse $response
     * @return $this
     */
