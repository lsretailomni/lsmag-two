...
class LSCInventoryLookupTable
{
    ...
    public \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetInventoryStatus $request;
    public \Ls\Omni\Client\Ecommerce\Entity\LSCInventoryLookupTableResponse $response;
    ...
    public function execute(\Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetInventoryStatus $request = null): \Ls\Omni\Client\Ecommerce\Entity\LSCInventoryLookupTableResponse
    {
        if ( !is_null( $request ) ) {
        ...
        $response = $this->dataHelper->makeRequest(
            \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetInventoryStatus::ACTION_NAME,
    ...
    public function formatResponse($data): \Ls\Omni\Client\Ecommerce\Entity\LSCInventoryLookupTableResponse
    {
    ...
    public function setRequest(\Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetInventoryStatus $request): self
    {
        $this->request = $request;
        return $this;
    }

    public function setResponse(\Ls\Omni\Client\Ecommerce\Entity\LSCInventoryLookupTableResponse $response): self
    {
        $this->response = $response;
        return $this;
    }

    public function getRequest(): \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetInventoryStatus
    {
        return $this->request;
    }

    public function getResponse(): \Ls\Omni\Client\Ecommerce\Entity\LSCInventoryLookupTableResponse
    {
