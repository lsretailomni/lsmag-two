...
use Ls\Omni\Client\Ecommerce\Entity\CustomerOrderEdit as CustomerOrderEditRequest;
use Ls\Omni\Client\Ecommerce\Entity\CustomerOrderEditResult as CustomerOrderEditResponse;

class CustomerOrderEdit extends AbstractOperation
{
    public const OPERATION_NAME = 'CustomerOrderEdit';
...
/** @noinspection PhpDocSignatureInspection */
    /**
     * @param CustomerOrderEditRequest $request
     * @return ResponseInterface|CustomerOrderEditResponse
     */
    ...
    /**
     * @return CustomerOrderEditRequest
     */
    public function & getOperationInput()
    {
        if ( is_null( $this->request ) ) {
            $this->request = new CustomerOrderEditRequest();
        }
        return $this->request;
    }
    ...
    public function setRequest(\CustomerOrderEditRequest $request)
    {
        $this->setData('request', $request);
        return $this;
    }

    public function getRequest() : \CustomerOrderEditRequest
    {
        return $this->request;
    }

    public function setResponse(\CustomerOrderEditResponse $response)
    {
        $this->setData('response', $response);
        return $this;
    }

    public function getResponse() : \CustomerOrderEditResponse
    {
