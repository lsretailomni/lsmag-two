...
class LSCWIMix&MatchOfferExt
{
    ...
    public function formatResponse($data): \Ls\Omni\Client\Ecommerce\Entity\LSCWIMix&MatchOfferExtResponse
    {
        ...
        if (!empty($fields)) {
            foreach ($rows as $row) {
                $values = $row['Fields'] ?? [];
                $entry = new \Ls\Omni\Client\Ecommerce\Entity\LSCWIMix&MatchOfferExt();
        ...
        return new \Ls\Omni\Client\Ecommerce\Entity\LSCWIMix&MatchOfferExtResponse([
            'records' => $results,
            'status' => $data['Status'] ?? '',
    ...
    public function setResponse(\Ls\Omni\Client\Ecommerce\Entity\LSCWIMix&MatchOfferExtResponse $response): self
    {
    ...
    public function getResponse(): \Ls\Omni\Client\Ecommerce\Entity\LSCWIMix&MatchOfferExtResponse
    {
