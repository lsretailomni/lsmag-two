...
use Ls\Omni\Client\Ecommerce\Entity\SPGOrderCheck as SPGOrderCheckRequest;
use Ls\Omni\Client\Ecommerce\Entity\SPGOrderCheckResult as SPGOrderCheckResponse;

class SPGOrderCheck extends AbstractOperation
{
    public const OPERATION_NAME = 'SPGOrderCheck';
...
/** @noinspection PhpDocSignatureInspection */
    /**
     * @param SPGOrderCheckRequest $request
     * @return ResponseInterface|SPGOrderCheckResponse
     */
    ...
    /**
     * @return SPGOrderCheckRequest
     */
    public function & getOperationInput()
    {
        if ( is_null( $this->request ) ) {
            $this->request = new SPGOrderCheckRequest();
        }
        return $this->request;
    }
    ...
    public function setRequest(\SPGOrderCheckRequest $request)
    {
        $this->setData('request', $request);
        return $this;
    }

    public function getRequest() : \SPGOrderCheckRequest
    {
        return $this->request;
    }

    public function setResponse(\SPGOrderCheckResponse $response)
    {
        $this->setData('response', $response);
        return $this;
    }

    public function getResponse() : \SPGOrderCheckResponse
    {
