...
class VariantRegView
{
    ...
    public \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetVariantRegWithStatus $request;
    public \Ls\Omni\Client\Ecommerce\Entity\VariantRegViewResponse $response;
    ...
    public function __construct($baseUrl = '', $connectionParams = [], $companyName = '')
    {
        ...
        $this->request = $this->createInstance(\Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetVariantRegWithStatus::class);
    }
    ...
    public function formatResponse($data): \Ls\Omni\Client\Ecommerce\Entity\VariantRegViewResponse
    {
        ...
        return $this->createInstance(
                    \Ls\Omni\Client\Ecommerce\Entity\VariantRegViewResponse::class,
                     [
                        'data' => [
                        'records' => $results,
                        'status' => $data['Status'] ?? '',
    ...
    public function & setOperationInput(array $params = []): \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetVariantRegWithStatus
    {
        $this->setRequest(
            $this->createInstance(
                \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetVariantRegWithStatus::class,
                ['data' => $params]
            )
        );
    ...
    public function setResponse(\Ls\Omni\Client\Ecommerce\Entity\VariantRegViewResponse $response): self
    {
        $this->response = $response;
        return $this;
    }

    public function getRequest(): \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetVariantRegWithStatus
    {
        return $this->request;
    }

    public function getResponse(): \Ls\Omni\Client\Ecommerce\Entity\VariantRegViewResponse
    {
