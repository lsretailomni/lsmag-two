...
use Ls\Omni\Client\Ecommerce\Entity\SalesEntriesGetByCardIdEx as SalesEntriesGetByCardIdExRequest;
use Ls\Omni\Client\Ecommerce\Entity\SalesEntriesGetByCardIdExResponse as SalesEntriesGetByCardIdExResponse;
...
class SalesEntriesGetByCardIdEx extends AbstractOperation
{
    ...
    /**
     * @property SalesEntriesGetByCardIdExRequest $request
     */
    protected $request = null;

    /**
     * @property SalesEntriesGetByCardIdExResponse $response
     */
    ...
    public function execute(RequestInterface $request = null)
    {
        ...
        return $this->makeRequest( 'SalesEntriesGetByCardIdEx' );
    }

    /**
     * @return SalesEntriesGetByCardIdExRequest
     */
    public function & getOperationInput()
    {
        if ( is_null( $this->request ) ) {
            $this->request = new SalesEntriesGetByCardIdExRequest();
        }
        return $this->request;
    }
    ...
    /**
     * @param SalesEntriesGetByCardIdExResponse $response
     * @return $this
     */
    ...
    /**
     * @return SalesEntriesGetByCardIdExResponse
     */
