...
class LSCWIDiscounts
{
    ...
    public \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetWIDiscounts $request;
    public \Ls\Omni\Client\Ecommerce\Entity\LSCWIDiscountsResponse $response;
    ...
    public function __construct($baseUrl = '', $connectionParams = [], $companyName = '')
    {
        ...
        $this->request = $this->createInstance(\Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetWIDiscounts::class);
    }
    ...
    public function formatResponse($data): \Ls\Omni\Client\Ecommerce\Entity\LSCWIDiscountsResponse
    {
        ...
        return $this->createInstance(
                    \Ls\Omni\Client\Ecommerce\Entity\LSCWIDiscountsResponse::class,
                     [
                        'data' => [
                        'records' => $results,
                        'status' => $data['Status'] ?? '',
    ...
    public function & setOperationInput(array $params = []): \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetWIDiscounts
    {
        $this->setRequest(
            $this->createInstance(
                \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetWIDiscounts::class,
                ['data' => $params]
            )
        );
    ...
    public function setResponse(\Ls\Omni\Client\Ecommerce\Entity\LSCWIDiscountsResponse $response): self
    {
        $this->response = $response;
        return $this;
    }

    public function getRequest(): \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetWIDiscounts
    {
        return $this->request;
    }

    public function getResponse(): \Ls\Omni\Client\Ecommerce\Entity\LSCWIDiscountsResponse
    {
