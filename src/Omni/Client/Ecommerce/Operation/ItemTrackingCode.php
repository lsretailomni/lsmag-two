...
class ItemTrackingCode
{
    ...
    public function __construct($baseUrl = '', $connectionParams = [], $companyName = '')
    {
        ...
        $this->request = $this->createInstance(\Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetItemTracking::class);
    }
    ...
    public function formatResponse($data): \Ls\Omni\Client\Ecommerce\Entity\ItemTrackingCodeResponse
    {
        ...
        return $this->createInstance(
                    \Ls\Omni\Client\Ecommerce\Entity\ItemTrackingCodeResponse::class,
                     [
                        'data' => [
                        'records' => $results,
                        'status' => $data['Status'] ?? '',
    ...
    public function & setOperationInput(array $params = []): \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetItemTracking
    {
        $this->setRequest(
            $this->createInstance(
                \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetItemTracking::class,
                ['data' => $params]
            )
        );
