...
class LSCWIExtd.VariantValues
{
    ...
    public function execute(\Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetExtdVariantValues $request = null): \Ls\Omni\Client\Ecommerce\Entity\LSCWIExtd.VariantValuesResponse
    {
        if ( !is_null( $request ) ) {
