...
class LSCRetailImageLink
{
    ...
    public function __construct($baseUrl = '', $connectionParams = [], $companyName = '')
    {
        ...
        $this->request = $this->createInstance(\Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetImageLink::class);
    }

    public function execute(): \Ls\Omni\Client\Ecommerce\Entity\LSCRetailImageLinkResponse
    {
    ...
    public function formatResponse($data): \Ls\Omni\Client\Ecommerce\Entity\LSCRetailImageLinkResponse
    {
        ...
        return $this->createInstance(
                    \Ls\Omni\Client\Ecommerce\Entity\LSCRetailImageLinkResponse::class,
                     [
                        'data' => [
                        'records' => $results,
                        'status' => $data['Status'] ?? '',
    ...
    public function & setOperationInput(array $params = []): \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetImageLink
    {
        $this->setRequest(
            $this->createInstance(
                \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetImageLink::class,
                ['data' => $params]
            )
        );
