...
class LSCRetailImageLink
{
    ...
    public function __construct($baseUrl = '', $connectionParams = [], $companyName = '')
    {
        ...
        $this->request = new \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetImageLink();
    }
    ...
    {
        $this->setRequest(new \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetImageLink($params));
