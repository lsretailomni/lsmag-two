...
use Ls\Omni\Client\Ecommerce\Entity\MobilePosPrint as MobilePosPrintRequest;
use Ls\Omni\Client\Ecommerce\Entity\MobilePosPrintResult as MobilePosPrintResponse;

class MobilePosPrint extends AbstractOperation
{
    public const OPERATION_NAME = 'MobilePosPrint';
...
/** @noinspection PhpDocSignatureInspection */
    /**
     * @param MobilePosPrintRequest $request
     * @return ResponseInterface|MobilePosPrintResponse
     */
    ...
    /**
     * @return MobilePosPrintRequest
     */
    public function & getOperationInput()
    {
        if ( is_null( $this->request ) ) {
            $this->request = new MobilePosPrintRequest();
        }
        return $this->request;
    }
    ...
    public function setRequest(\MobilePosPrintRequest $request)
    {
        $this->setData('request', $request);
        return $this;
    }

    public function getRequest() : \MobilePosPrintRequest
    {
        return $this->request;
    }

    public function setResponse(\MobilePosPrintResponse $response)
    {
        $this->setData('response', $response);
        return $this;
    }

    public function getResponse() : \MobilePosPrintResponse
    {
