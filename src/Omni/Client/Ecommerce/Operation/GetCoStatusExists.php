...
use Ls\Omni\Client\Ecommerce\Entity\GetCoStatusExists as GetCoStatusExistsRequest;
use Ls\Omni\Client\Ecommerce\Entity\GetCoStatusExistsResult as GetCoStatusExistsResponse;

class GetCoStatusExists extends AbstractOperation
{
    public const OPERATION_NAME = 'GetCoStatusExists';
...
/** @noinspection PhpDocSignatureInspection */
    /**
     * @param GetCoStatusExistsRequest $request
     * @return ResponseInterface|GetCoStatusExistsResponse
     */
    ...
    /**
     * @return GetCoStatusExistsRequest
     */
    public function & getOperationInput()
    {
        if ( is_null( $this->request ) ) {
            $this->request = new GetCoStatusExistsRequest();
        }
        return $this->request;
    }
    ...
    public function setRequest(\GetCoStatusExistsRequest $request)
    {
        $this->setData('request', $request);
        return $this;
    }

    public function getRequest() : \GetCoStatusExistsRequest
    {
        return $this->request;
    }

    public function setResponse(\GetCoStatusExistsResponse $response)
    {
        $this->setData('response', $response);
        return $this;
    }

    public function getResponse() : \GetCoStatusExistsResponse
    {
