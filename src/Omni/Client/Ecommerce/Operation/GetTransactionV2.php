...
use Ls\Omni\Client\Ecommerce\Entity\GetTransactionV2 as GetTransactionV2Request;
use Ls\Omni\Client\Ecommerce\Entity\GetTransactionV2Result as GetTransactionV2Response;

class GetTransactionV2 extends AbstractOperation
{
    public const OPERATION_NAME = 'GetTransactionV2';
...
/** @noinspection PhpDocSignatureInspection */
    /**
     * @param GetTransactionV2Request $request
     * @return ResponseInterface|GetTransactionV2Response
     */
    ...
    /**
     * @return GetTransactionV2Request
     */
    public function & getOperationInput()
    {
        if ( is_null( $this->request ) ) {
            $this->request = new GetTransactionV2Request();
        }
        return $this->request;
    }
    ...
    public function setRequest(\GetTransactionV2Request $request)
    {
        $this->setData('request', $request);
        return $this;
    }

    public function getRequest() : \GetTransactionV2Request
    {
        return $this->request;
    }

    public function setResponse(\GetTransactionV2Response $response)
    {
        $this->setData('response', $response);
        return $this;
    }

    public function getResponse() : \GetTransactionV2Response
    {
