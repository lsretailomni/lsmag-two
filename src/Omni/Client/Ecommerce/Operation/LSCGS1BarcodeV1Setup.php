...
class LSCGS1BarcodeV1Setup
{
    ...
    public \Ls\Omni\Client\Ecommerce\Entity\LSCGS1BarcodeV1SetupResponse $response;
    ...
    public function execute(): \Ls\Omni\Client\Ecommerce\Entity\LSCGS1BarcodeV1SetupResponse
    {
        $response = $this->dataHelper->makeRequest(
            \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetBarcodeGS1Setup::ACTION_NAME,
            \Ls\Omni\Client\Ecommerce\Entity\LSCGS1BarcodeV1Setup::class,
            $this->request,
            $this->baseUrl,
    ...
    public function formatResponse($data): \Ls\Omni\Client\Ecommerce\Entity\LSCGS1BarcodeV1SetupResponse
    {
        ...
        return $this->createInstance(
                    \Ls\Omni\Client\Ecommerce\Entity\LSCGS1BarcodeV1SetupResponse::class,
                     [
                        'data' => [
                        'records' => $results,
                        'status' => $data['Status'] ?? '',
    ...
    public function setResponse(\Ls\Omni\Client\Ecommerce\Entity\LSCGS1BarcodeV1SetupResponse $response): self
    {
    ...
    public function getResponse(): \Ls\Omni\Client\Ecommerce\Entity\LSCGS1BarcodeV1SetupResponse
    {
