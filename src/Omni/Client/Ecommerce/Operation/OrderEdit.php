...
use Ls\Omni\Client\Ecommerce\Entity\OrderEdit as OrderEditRequest;
use Ls\Omni\Client\Ecommerce\Entity\OrderEditResponse as OrderEditResponse;

class OrderEdit extends AbstractOperation
{
    public const OPERATION_NAME = 'ORDER_EDIT';
    ...
    /**
     * @property OrderEditRequest $request
     */
    protected $request = null;

    /**
     * @property OrderEditResponse $response
     */
    ...
    public function execute(RequestInterface $request = null)
    {
        ...
        return $this->makeRequest( 'OrderEdit' );
    }
    ...
    public function & getOperationInput()
    {
        if ( is_null( $this->request ) ) {
            $this->request = new OrderEditRequest();
        }
        return $this->request;
    }
    ...
    /**
     * @param OrderEditResponse $response
     * @return $this
     */
