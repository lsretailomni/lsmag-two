...
class Vendor
{
    ...
    public \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetVendor $request;
    public \Ls\Omni\Client\Ecommerce\Entity\VendorResponse $response;
    ...
    public function execute(\Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetVendor $request = null): \Ls\Omni\Client\Ecommerce\Entity\VendorResponse
    {
        if ( !is_null( $request ) ) {
        ...
        $response = $this->dataHelper->makeRequest(
            \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetVendor::ACTION_NAME,
    ...
    public function formatResponse($data): \Ls\Omni\Client\Ecommerce\Entity\VendorResponse
    {
    ...
    public function setRequest(\Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetVendor $request): self
    {
        $this->request = $request;
        return $this;
    }

    public function setResponse(\Ls\Omni\Client\Ecommerce\Entity\VendorResponse $response): self
    {
        $this->response = $response;
        return $this;
    }

    public function getRequest(): \Ls\Omni\Client\Ecommerce\Entity\ODataRequest_GetVendor
    {
        return $this->request;
    }

    public function getResponse(): \Ls\Omni\Client\Ecommerce\Entity\VendorResponse
    {
