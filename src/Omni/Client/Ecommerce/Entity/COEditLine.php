...
class COEditLine extends \Magento\Catalog\Model\AbstractModel
{
    ...
    public const CREATED_BY_RECEIPT = 'CreatedByReceipt';
     ...
     * @return $this
     */
    public function setCreatedByReceipt($CreatedByReceipt)
    {
     ...
     * @return string
     */
    public function getCreatedByReceipt()
    {
