...
use Ls\Omni\Client\CentralEcommerce\Entity\MobilePosSetDeviceID as MobilePosSetDeviceIDRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\MobilePosSetDeviceIDResult as MobilePosSetDeviceIDResponse;
...
class MobilePosSetDeviceID extends AbstractOperation
{
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                MobilePosSetDeviceIDRequest::class,
                ['data' => $params]
            )
        );
