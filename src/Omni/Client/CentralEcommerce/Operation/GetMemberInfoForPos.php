...
use Ls\Omni\Client\CentralEcommerce\Entity\GetMemberInfoForPos as GetMemberInfoForPosRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\GetMemberInfoForPosResult as GetMemberInfoForPosResponse;
...
class GetMemberInfoForPos extends AbstractOperation
{
    ...
    /**
     * @property GetMemberInfoForPosRequest $request
     */
    public $request = null;

    /**
     * @property GetMemberInfoForPosResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                GetMemberInfoForPosRequest::class,
                ['data' => $params]
            )
        );
