...
use Ls\Omni\Client\CentralEcommerce\Entity\COUpdatePaymentV2 as COUpdatePaymentV2Request;
use Ls\Omni\Client\CentralEcommerce\Entity\COUpdatePaymentV2Result as COUpdatePaymentV2Response;

class COUpdatePaymentV2 extends AbstractOperation
{
    public const OPERATION_NAME = 'COUpdatePaymentV2';
    ...
    /**
     * @property COUpdatePaymentV2Request $request
     */
    public $request = null;

    /**
     * @property COUpdatePaymentV2Response $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                COUpdatePaymentV2Request::class,
                ['data' => $params]
            )
        );
    ...
    public function setRequest(COUpdatePaymentV2Request $request)
    {
        $this->request = $request;
        return $this;
    }

    public function getRequest(): COUpdatePaymentV2Request
    {
        return $this->request;
    }

    public function setResponse(COUpdatePaymentV2Response $response)
    {
        $this->response = $response;
        return $this;
    }

    public function getResponse(): COUpdatePaymentV2Response
    {
