...
use Ls\Omni\Client\CentralEcommerce\Entity\COMobileUnlockLines as COMobileUnlockLinesRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\COMobileUnlockLinesResult as COMobileUnlockLinesResponse;
...
class COMobileUnlockLines extends AbstractOperation
{
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                COMobileUnlockLinesRequest::class,
                ['data' => $params]
            )
        );
