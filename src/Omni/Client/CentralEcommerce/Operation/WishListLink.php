...
use Ls\Omni\Client\CentralEcommerce\Entity\WishListLink as WishListLinkRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\WishListLinkResult as WishListLinkResponse;

class WishListLink extends AbstractOperation
{
    public const OPERATION_NAME = 'WishListLink';
    ...
    /**
     * @property WishListLinkRequest $request
     */
    public $request = null;

    /**
     * @property WishListLinkResponse $response
     */
    ...
    public function setRequest(WishListLinkRequest $request)
    {
        $this->request = $request;
        return $this;
    }

    public function getRequest(): WishListLinkRequest
    {
        return $this->request;
    }

    public function setResponse(WishListLinkResponse $response)
    {
        $this->response = $response;
        return $this;
    }

    public function getResponse(): WishListLinkResponse
    {
