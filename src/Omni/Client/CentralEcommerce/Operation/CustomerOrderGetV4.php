...
use Ls\Omni\Client\CentralEcommerce\Entity\CustomerOrderGetV4 as CustomerOrderGetV4Request;
use Ls\Omni\Client\CentralEcommerce\Entity\CustomerOrderGetV4Result as CustomerOrderGetV4Response;

class CustomerOrderGetV4 extends AbstractOperation
{
    public const OPERATION_NAME = 'CustomerOrderGetV4';
    ...
    /**
     * @property CustomerOrderGetV4Request $request
     */
    public $request = null;

    /**
     * @property CustomerOrderGetV4Response $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                CustomerOrderGetV4Request::class,
                ['data' => $params]
            )
        );
    ...
    public function setRequest(CustomerOrderGetV4Request $request)
    {
        $this->request = $request;
        return $this;
    }

    public function getRequest(): CustomerOrderGetV4Request
    {
        return $this->request;
    }

    public function setResponse(CustomerOrderGetV4Response $response)
    {
        $this->response = $response;
        return $this;
    }

    public function getResponse(): CustomerOrderGetV4Response
    {
