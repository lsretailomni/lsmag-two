...
use Ls\Omni\Client\CentralEcommerce\Entity\GetMemberContact2 as GetMemberContact2Request;
use Ls\Omni\Client\CentralEcommerce\Entity\GetMemberContact2Result as GetMemberContact2Response;
...
class GetMemberContact2 extends AbstractOperation
{
    ...
    /**
     * @property GetMemberContact2Request $request
     */
    public $request = null;

    /**
     * @property GetMemberContact2Response $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                GetMemberContact2Request::class,
                ['data' => $params]
            )
        );
