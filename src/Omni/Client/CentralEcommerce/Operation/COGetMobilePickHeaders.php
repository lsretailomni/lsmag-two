...
use Ls\Omni\Client\CentralEcommerce\Entity\COGetMobilePickHeaders as COGetMobilePickHeadersRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\COGetMobilePickHeadersResult as COGetMobilePickHeadersResponse;
...
class COGetMobilePickHeaders extends AbstractOperation
{
    ...
    /**
     * @property COGetMobilePickHeadersRequest $request
     */
    public $request = null;

    /**
     * @property COGetMobilePickHeadersResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                COGetMobilePickHeadersRequest::class,
                ['data' => $params]
            )
        );
