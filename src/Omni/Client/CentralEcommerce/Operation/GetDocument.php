...
use Ls\Omni\Client\CentralEcommerce\Entity\GetDocument as GetDocumentRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\GetDocumentResult as GetDocumentResponse;

class GetDocument extends AbstractOperation
{
    public const OPERATION_NAME = 'GetDocument';
    ...
    /**
     * @property GetDocumentRequest $request
     */
    public $request = null;

    /**
     * @property GetDocumentResponse $response
     */
    ...
    public function setRequest(GetDocumentRequest $request)
    {
        $this->request = $request;
        return $this;
    }

    public function getRequest() : GetDocumentRequest
    {
        return $this->request;
    }

    public function setResponse(GetDocumentResponse $response)
    {
        $this->response = $response;
        return $this;
    }

    public function getResponse() : GetDocumentResponse
    {
