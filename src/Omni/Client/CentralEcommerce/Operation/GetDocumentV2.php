...
use Ls\Omni\Client\CentralEcommerce\Entity\GetDocumentV2 as GetDocumentV2Request;
use Ls\Omni\Client\CentralEcommerce\Entity\GetDocumentV2Result as GetDocumentV2Response;

class GetDocumentV2 extends AbstractOperation
{
    public const OPERATION_NAME = 'GetDocumentV2';
    ...
    /**
     * @property GetDocumentV2Request $request
     */
    public $request = null;

    /**
     * @property GetDocumentV2Response $response
     */
    ...
    public function setRequest(GetDocumentV2Request $request)
    {
        $this->request = $request;
        return $this;
    }

    public function getRequest(): GetDocumentV2Request
    {
        return $this->request;
    }

    public function setResponse(GetDocumentV2Response $response)
    {
        $this->response = $response;
        return $this;
    }

    public function getResponse(): GetDocumentV2Response
    {
