...
use Ls\Omni\Client\CentralEcommerce\Entity\COGetPutBackItems as COGetPutBackItemsRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\COGetPutBackItemsResult as COGetPutBackItemsResponse;

class COGetPutBackItems extends AbstractOperation
{
    public const OPERATION_NAME = 'COGetPutBackItems';
