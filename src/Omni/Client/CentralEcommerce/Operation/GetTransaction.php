...
use Ls\Omni\Client\CentralEcommerce\Entity\GetTransaction as GetTransactionRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\GetTransactionResult as GetTransactionResponse;

class GetTransaction extends AbstractOperation
{
    public const OPERATION_NAME = 'GetTransaction';
    ...
    /**
     * @property GetTransactionRequest $request
     */
    public $request = null;

    /**
     * @property GetTransactionResponse $response
     */
    ...
    public function setRequest(GetTransactionRequest $request)
    {
        $this->request = $request;
        return $this;
    }

    public function getRequest() : GetTransactionRequest
    {
        return $this->request;
    }

    public function setResponse(GetTransactionResponse $response)
    {
        $this->response = $response;
        return $this;
    }

    public function getResponse() : GetTransactionResponse
    {
