...
class HierarchyNodesLinkView
{
    ...
    public \Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetHierarchyLeaf $request;
    public \Ls\Omni\Client\CentralEcommerce\Entity\HierarchyNodesLinkViewResponse $response;
    ...
    public function __construct($baseUrl = '', $connectionParams = [], $companyName = '')
    {
        ...
        $this->request = $this->createInstance(\Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetHierarchyLeaf::class);
    }

    public function execute(): \Ls\Omni\Client\CentralEcommerce\Entity\HierarchyNodesLinkViewResponse
    {
        $response = $this->dataHelper->makeRequest(
            \Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetHierarchyLeaf::ACTION_NAME,
            \Ls\Omni\Client\CentralEcommerce\Entity\HierarchyNodesLinkView::class,
            $this->request,
            $this->baseUrl,
    ...
    public function formatResponse($data): \Ls\Omni\Client\CentralEcommerce\Entity\HierarchyNodesLinkViewResponse
    {
        ...
        return $this->createInstance(
                    \Ls\Omni\Client\CentralEcommerce\Entity\HierarchyNodesLinkViewResponse::class,
                     [
                        'data' => [
                        'records' => $results,
                        'status' => $data['Status'] ?? '',
    ...
    public function & setOperationInput(array $params = []): \Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetHierarchyLeaf
    {
        $this->setRequest(
            $this->createInstance(
                \Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetHierarchyLeaf::class,
                ['data' => $params]
            )
        );
    ...
    public function setRequest(\Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetHierarchyLeaf $request): self
    {
        $this->request = $request;
        return $this;
    }

    public function setResponse(\Ls\Omni\Client\CentralEcommerce\Entity\HierarchyNodesLinkViewResponse $response): self
    {
        $this->response = $response;
        return $this;
    }

    public function getRequest(): \Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetHierarchyLeaf
    {
        return $this->request;
    }

    public function getResponse(): \Ls\Omni\Client\CentralEcommerce\Entity\HierarchyNodesLinkViewResponse
    {
