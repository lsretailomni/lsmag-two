...
use Ls\Omni\Client\CentralEcommerce\Entity\StoreInventoryLinesGet as StoreInventoryLinesGetRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\StoreInventoryLinesGetResult as StoreInventoryLinesGetResponse;
...
class StoreInventoryLinesGet extends AbstractOperation
{
    ...
    /**
     * @property StoreInventoryLinesGetRequest $request
     */
    public $request = null;

    /**
     * @property StoreInventoryLinesGetResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                StoreInventoryLinesGetRequest::class,
                ['data' => $params]
            )
        );
