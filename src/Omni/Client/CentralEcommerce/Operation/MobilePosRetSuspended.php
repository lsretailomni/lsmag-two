...
use Ls\Omni\Client\CentralEcommerce\Entity\MobilePosRetSuspended as MobilePosRetSuspendedRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\MobilePosRetSuspendedResult as MobilePosRetSuspendedResponse;
...
class MobilePosRetSuspended extends AbstractOperation
{
    ...
    /**
     * @property MobilePosRetSuspendedRequest $request
     */
    public $request = null;

    /**
     * @property MobilePosRetSuspendedResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                MobilePosRetSuspendedRequest::class,
                ['data' => $params]
            )
        );
