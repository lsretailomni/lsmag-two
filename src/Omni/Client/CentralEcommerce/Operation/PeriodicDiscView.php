...
class PeriodicDiscView
{
    public string $baseUrl;
    public array $connectionParams;
    public string $companyName;
    public \Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetDiscountSetupWPGLookup $request;
    public \Ls\Omni\Client\CentralEcommerce\Entity\PeriodicDiscViewResponse $response;
    ...
    public function __construct($baseUrl = '', $connectionParams = [], $companyName = '')
    {
        ...
        $this->request = $this->createInstance(\Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetDiscountSetupWPGLookup::class);
    }

    public function execute(): \Ls\Omni\Client\CentralEcommerce\Entity\PeriodicDiscViewResponse
    {
        $response = $this->dataHelper->makeRequest(
            \Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetDiscountSetupWPGLookup::ACTION_NAME,
            \Ls\Omni\Client\CentralEcommerce\Entity\PeriodicDiscView::class,
            $this->request,
            $this->baseUrl,
    ...
    public function formatResponse($data): \Ls\Omni\Client\CentralEcommerce\Entity\PeriodicDiscViewResponse
    {
        ...
        return $this->createInstance(
                    \Ls\Omni\Client\CentralEcommerce\Entity\PeriodicDiscViewResponse::class,
                     [
                        'data' => [
                        'records' => $results,
                        'status' => $data['Status'] ?? '',
    ...
    public function & setOperationInput(array $params = []): \Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetDiscountSetupWPGLookup
    {
        $this->setRequest(
            $this->createInstance(
                \Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetDiscountSetupWPGLookup::class,
                ['data' => $params]
            )
        );
    ...
    public function setRequest(\Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetDiscountSetupWPGLookup $request): self
    {
        $this->request = $request;
        return $this;
    }

    public function setResponse(\Ls\Omni\Client\CentralEcommerce\Entity\PeriodicDiscViewResponse $response): self
    {
        $this->response = $response;
        return $this;
    }

    public function getRequest(): \Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetDiscountSetupWPGLookup
    {
        return $this->request;
    }

    public function getResponse(): \Ls\Omni\Client\CentralEcommerce\Entity\PeriodicDiscViewResponse
    {
