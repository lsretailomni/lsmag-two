...
use Ls\Omni\Client\CentralEcommerce\Entity\COFilteredListV3 as COFilteredListV3Request;
use Ls\Omni\Client\CentralEcommerce\Entity\COFilteredListV3Result as COFilteredListV3Response;

class COFilteredListV3 extends AbstractOperation
{
    public const OPERATION_NAME = 'COFilteredListV3';
    ...
    /**
     * @property COFilteredListV3Request $request
     */
    public $request = null;

    /**
     * @property COFilteredListV3Response $response
     */
    ...
    public function setRequest(COFilteredListV3Request $request)
    {
        $this->request = $request;
        return $this;
    }

    public function getRequest(): COFilteredListV3Request
    {
        return $this->request;
    }

    public function setResponse(COFilteredListV3Response $response)
    {
        $this->response = $response;
        return $this;
    }

    public function getResponse(): COFilteredListV3Response
    {
