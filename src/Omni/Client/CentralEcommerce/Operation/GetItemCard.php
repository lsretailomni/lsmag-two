...
use Ls\Omni\Client\CentralEcommerce\Entity\GetItemCard as GetItemCardRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\GetItemCardResult as GetItemCardResponse;
...
class GetItemCard extends AbstractOperation
{
    ...
    /**
     * @property GetItemCardRequest $request
     */
    public $request = null;

    /**
     * @property GetItemCardResponse $response
     */
