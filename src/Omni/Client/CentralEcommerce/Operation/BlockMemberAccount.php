...
use Ls\Omni\Client\CentralEcommerce\Entity\BlockMemberAccount as BlockMemberAccountRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\BlockMemberAccountResult as BlockMemberAccountResponse;
...
class BlockMemberAccount extends AbstractOperation
{
    ...
    /**
     * @property BlockMemberAccountRequest $request
     */
    public $request = null;

    /**
     * @property BlockMemberAccountResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                BlockMemberAccountRequest::class,
                ['data' => $params]
            )
        );
