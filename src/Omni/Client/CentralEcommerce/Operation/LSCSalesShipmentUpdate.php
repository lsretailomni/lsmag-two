...
use Ls\Omni\Client\CentralEcommerce\Entity\LSCSalesShipmentUpdate as LSCSalesShipmentUpdateRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\LSCSalesShipmentUpdateResult as LSCSalesShipmentUpdateResponse;
...
class LSCSalesShipmentUpdate extends AbstractOperation
{
    ...
    /**
     * @property LSCSalesShipmentUpdateRequest $request
     */
    public $request = null;

    /**
     * @property LSCSalesShipmentUpdateResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                LSCSalesShipmentUpdateRequest::class,
                ['data' => $params]
            )
        );
