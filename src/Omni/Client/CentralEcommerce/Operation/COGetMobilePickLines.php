...
use Ls\Omni\Client\CentralEcommerce\Entity\COGetMobilePickLines as COGetMobilePickLinesRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\COGetMobilePickLinesResult as COGetMobilePickLinesResponse;
...
class COGetMobilePickLines extends AbstractOperation
{
    ...
    /**
     * @property COGetMobilePickLinesRequest $request
     */
    public $request = null;

    /**
     * @property COGetMobilePickLinesResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                COGetMobilePickLinesRequest::class,
                ['data' => $params]
            )
        );
