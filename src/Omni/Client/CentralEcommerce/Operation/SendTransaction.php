...
use Ls\Omni\Client\CentralEcommerce\Entity\SendTransaction as SendTransactionRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\SendTransactionResult as SendTransactionResponse;
...
class SendTransaction extends AbstractOperation
{
    ...
    /**
     * @property SendTransactionRequest $request
     */
    public $request = null;

    /**
     * @property SendTransactionResponse $response
     */
