...
use Ls\Omni\Client\CentralEcommerce\Entity\MemberAuthenticatorLogin as MemberAuthenticatorLoginRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\MemberAuthenticatorLoginResult as MemberAuthenticatorLoginResponse;
...
class MemberAuthenticatorLogin extends AbstractOperation
{
    ...
    /**
     * @property MemberAuthenticatorLoginRequest $request
     */
    public $request = null;

    /**
     * @property MemberAuthenticatorLoginResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                MemberAuthenticatorLoginRequest::class,
                ['data' => $params]
            )
        );
