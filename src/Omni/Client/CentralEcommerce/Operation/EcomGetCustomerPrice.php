...
use Ls\Omni\Client\CentralEcommerce\Entity\EcomGetCustomerPrice as EcomGetCustomerPriceRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\EcomGetCustomerPriceResult as EcomGetCustomerPriceResponse;
...
class EcomGetCustomerPrice extends AbstractOperation
{
    ...
    /**
     * @property EcomGetCustomerPriceRequest $request
     */
    public $request = null;

    /**
     * @property EcomGetCustomerPriceResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                EcomGetCustomerPriceRequest::class,
                ['data' => $params]
            )
        );
