...
class GetDiscount_GetDiscount
{
    ...
    public \Ls\Omni\Client\CentralEcommerce\Entity\GetDiscount_GetDiscountRequest $request;
    public \Ls\Omni\Client\CentralEcommerce\Entity\GetDiscount_GetDiscountResponse $response;
    ...
    public function __construct(string $baseUrl = '', array $connectionParams = [], string $companyName = '')
    {
        ...
        $this->request = $this->createInstance(\Ls\Omni\Client\CentralEcommerce\Entity\GetDiscount_GetDiscountRequest::class);
    }

    public function execute(): \Ls\Omni\Client\CentralEcommerce\Entity\GetDiscount_GetDiscountResponse
    {
        $raw = $this->dataHelper->makeRequest(
            \Ls\Omni\Client\CentralEcommerce\Entity\GetDiscount_GetDiscountRequest::ACTION_NAME,
            self::class,
            $this->request,
            $this->baseUrl,
    ...
    public function formatResponse($data): \Ls\Omni\Client\CentralEcommerce\Entity\GetDiscount_GetDiscountResponse
    {
        ...
        $finalEntry = $this->createInstance(\Ls\Omni\Client\CentralEcommerce\Entity\GetDiscount_GetDiscount::class);
            ...
            foreach ($requiredDataSetName as $dataSet) {
                ...
                if (isset($data[$dataSet]) && is_array($data[$dataSet])) {
                    $entity = $this->createInstance(
                        \Ls\Omni\Client\CentralEcommerce\Entity\GetDiscount_GetDiscount::class,
                    ...
                    return $this->createInstance(
                        \Ls\Omni\Client\CentralEcommerce\Entity\GetDiscount_GetDiscountResponse::class,
                       [
                       'data' =>
                           [
                                'records' => [$entity],
    ...
    public function & setOperationInput(array $params = []): \Ls\Omni\Client\CentralEcommerce\Entity\GetDiscount_GetDiscountRequest
    {
        $this->setRequest(
            $this->createInstance(
                \Ls\Omni\Client\CentralEcommerce\Entity\GetDiscount_GetDiscountRequest::class,
                ['data' => $params]
            )
        );
    ...
    public function setRequest(\Ls\Omni\Client\CentralEcommerce\Entity\GetDiscount_GetDiscountRequest $request): self
    {
        $this->request = $request;
        return $this;
    }

    public function setResponse(\Ls\Omni\Client\CentralEcommerce\Entity\GetDiscount_GetDiscountResponse $response): self
    {
        $this->response = $response;
        return $this;
    }

    public function getRequest(): \Ls\Omni\Client\CentralEcommerce\Entity\GetDiscount_GetDiscountRequest
    {
        return $this->request;
    }

    public function getResponse(): \Ls\Omni\Client\CentralEcommerce\Entity\GetDiscount_GetDiscountResponse
    {
