...
use Ls\Omni\Client\CentralEcommerce\Entity\CustomerOrderEdit as CustomerOrderEditRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\CustomerOrderEditResult as CustomerOrderEditResponse;
...
class CustomerOrderEdit extends AbstractOperation
{
    ...
    /**
     * @property CustomerOrderEditRequest $request
     */
    public $request = null;

    /**
     * @property CustomerOrderEditResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                CustomerOrderEditRequest::class,
                ['data' => $params]
            )
        );
