...
use Ls\Omni\Client\CentralEcommerce\Entity\GetVoucherEntriesV2 as GetVoucherEntriesV2Request;
use Ls\Omni\Client\CentralEcommerce\Entity\GetVoucherEntriesV2Result as GetVoucherEntriesV2Response;
...
class GetVoucherEntriesV2 extends AbstractOperation
{
    ...
    /**
     * @property GetVoucherEntriesV2Request $request
     */
    public $request = null;

    /**
     * @property GetVoucherEntriesV2Response $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                GetVoucherEntriesV2Request::class,
                ['data' => $params]
            )
        );
