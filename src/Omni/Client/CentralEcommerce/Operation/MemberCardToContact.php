...
use Ls\Omni\Client\CentralEcommerce\Entity\MemberCardToContact as MemberCardToContactRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\MemberCardToContactResult as MemberCardToContactResponse;
...
class MemberCardToContact extends AbstractOperation
{
    ...
    /**
     * @property MemberCardToContactRequest $request
     */
    public $request = null;

    /**
     * @property MemberCardToContactResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                MemberCardToContactRequest::class,
                ['data' => $params]
            )
        );
