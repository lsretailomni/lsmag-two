...
use Ls\Omni\Client\CentralEcommerce\Entity\MobilePosPriceCheck as MobilePosPriceCheckRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\MobilePosPriceCheckResult as MobilePosPriceCheckResponse;
...
class MobilePosPriceCheck extends AbstractOperation
{
    ...
    /**
     * @property MobilePosPriceCheckRequest $request
     */
    public $request = null;

    /**
     * @property MobilePosPriceCheckResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                MobilePosPriceCheckRequest::class,
                ['data' => $params]
            )
        );
