...
use Ls\Omni\Client\CentralEcommerce\Entity\MobilePosPrint as MobilePosPrintRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\MobilePosPrintResult as MobilePosPrintResponse;
...
class MobilePosPrint extends AbstractOperation
{
    ...
    /**
     * @property MobilePosPrintRequest $request
     */
    public $request = null;

    /**
     * @property MobilePosPrintResponse $response
     */
