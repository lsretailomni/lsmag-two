...
class LSCItemVariantRegistration
{
    ...
    public \Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetVariantReg $request;
    public \Ls\Omni\Client\CentralEcommerce\Entity\LSCItemVariantRegistrationResponse $response;
    ...
    public function __construct($baseUrl = '', $connectionParams = [], $companyName = '')
    {
        ...
        $this->request = $this->createInstance(\Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetVariantReg::class);
    }

    public function execute(): \Ls\Omni\Client\CentralEcommerce\Entity\LSCItemVariantRegistrationResponse
    {
        $response = $this->dataHelper->makeRequest(
            \Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetVariantReg::ACTION_NAME,
            \Ls\Omni\Client\CentralEcommerce\Entity\LSCItemVariantRegistration::class,
            $this->request,
            $this->baseUrl,
    ...
    public function formatResponse($data): \Ls\Omni\Client\CentralEcommerce\Entity\LSCItemVariantRegistrationResponse
    {
        ...
        return $this->createInstance(
                    \Ls\Omni\Client\CentralEcommerce\Entity\LSCItemVariantRegistrationResponse::class,
                     [
                        'data' => [
                        'records' => $results,
                        'status' => $data['Status'] ?? '',
    ...
    public function & setOperationInput(array $params = []): \Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetVariantReg
    {
        $this->setRequest(
            $this->createInstance(
                \Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetVariantReg::class,
                ['data' => $params]
            )
        );
    ...
    public function setRequest(\Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetVariantReg $request): self
    {
        $this->request = $request;
        return $this;
    }

    public function setResponse(\Ls\Omni\Client\CentralEcommerce\Entity\LSCItemVariantRegistrationResponse $response): self
    {
        $this->response = $response;
        return $this;
    }

    public function getRequest(): \Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetVariantReg
    {
        return $this->request;
    }

    public function getResponse(): \Ls\Omni\Client\CentralEcommerce\Entity\LSCItemVariantRegistrationResponse
    {
