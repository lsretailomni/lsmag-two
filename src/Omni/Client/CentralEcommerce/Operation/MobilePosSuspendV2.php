...
use Ls\Omni\Client\CentralEcommerce\Entity\MobilePosSuspendV2 as MobilePosSuspendV2Request;
use Ls\Omni\Client\CentralEcommerce\Entity\MobilePosSuspendV2Result as MobilePosSuspendV2Response;
...
class MobilePosSuspendV2 extends AbstractOperation
{
    ...
    /**
     * @property MobilePosSuspendV2Request $request
     */
    public $request = null;

    /**
     * @property MobilePosSuspendV2Response $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                MobilePosSuspendV2Request::class,
                ['data' => $params]
            )
        );
