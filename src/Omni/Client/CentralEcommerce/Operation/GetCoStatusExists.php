...
use Ls\Omni\Client\CentralEcommerce\Entity\GetCoStatusExists as GetCoStatusExistsRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\GetCoStatusExistsResult as GetCoStatusExistsResponse;
...
class GetCoStatusExists extends AbstractOperation
{
    ...
    /**
     * @property GetCoStatusExistsRequest $request
     */
    public $request = null;

    /**
     * @property GetCoStatusExistsResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                GetCoStatusExistsRequest::class,
                ['data' => $params]
            )
        );
