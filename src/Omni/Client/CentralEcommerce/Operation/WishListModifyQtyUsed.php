...
use Ls\Omni\Client\CentralEcommerce\Entity\WishListModifyQtyUsed as WishListModifyQtyUsedRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\WishListModifyQtyUsedResult as WishListModifyQtyUsedResponse;

class WishListModifyQtyUsed extends AbstractOperation
{
    public const OPERATION_NAME = 'WishListModifyQtyUsed';
    ...
    /**
     * @property WishListModifyQtyUsedRequest $request
     */
    public $request = null;

    /**
     * @property WishListModifyQtyUsedResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                WishListModifyQtyUsedRequest::class,
                ['data' => $params]
            )
        );
    ...
    public function setRequest(WishListModifyQtyUsedRequest $request)
    {
        $this->request = $request;
        return $this;
    }

    public function getRequest(): WishListModifyQtyUsedRequest
    {
        return $this->request;
    }

    public function setResponse(WishListModifyQtyUsedResponse $response)
    {
        $this->response = $response;
        return $this;
    }

    public function getResponse(): WishListModifyQtyUsedResponse
    {
