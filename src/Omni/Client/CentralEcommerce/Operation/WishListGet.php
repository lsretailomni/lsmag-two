...
use Ls\Omni\Client\CentralEcommerce\Entity\WishListGet as WishListGetRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\WishListGetResult as WishListGetResponse;

class WishListGet extends AbstractOperation
{
    public const OPERATION_NAME = 'WishListGet';
    ...
    /**
     * @property WishListGetRequest $request
     */
    public $request = null;

    /**
     * @property WishListGetResponse $response
     */
    ...
    public function setRequest(WishListGetRequest $request)
    {
        $this->request = $request;
        return $this;
    }

    public function getRequest(): WishListGetRequest
    {
        return $this->request;
    }

    public function setResponse(WishListGetResponse $response)
    {
        $this->response = $response;
        return $this;
    }

    public function getResponse(): WishListGetResponse
    {
