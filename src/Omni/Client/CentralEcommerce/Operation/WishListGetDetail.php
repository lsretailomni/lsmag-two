...
use Ls\Omni\Client\CentralEcommerce\Entity\WishListGetDetail as WishListGetDetailRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\WishListGetDetailResult as WishListGetDetailResponse;

class WishListGetDetail extends AbstractOperation
{
    public const OPERATION_NAME = 'WishListGetDetail';
    ...
    /**
     * @property WishListGetDetailRequest $request
     */
    public $request = null;

    /**
     * @property WishListGetDetailResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                WishListGetDetailRequest::class,
                ['data' => $params]
            )
        );
    ...
    public function setRequest(WishListGetDetailRequest $request)
    {
        $this->request = $request;
        return $this;
    }

    public function getRequest(): WishListGetDetailRequest
    {
        return $this->request;
    }

    public function setResponse(WishListGetDetailResponse $response)
    {
        $this->response = $response;
        return $this;
    }

    public function getResponse(): WishListGetDetailResponse
    {
