...
use Ls\Omni\Client\CentralEcommerce\Entity\WishListItemModify as WishListItemModifyRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\WishListItemModifyResult as WishListItemModifyResponse;

class WishListItemModify extends AbstractOperation
{
    public const OPERATION_NAME = 'WishListItemModify';
    ...
    /**
     * @property WishListItemModifyRequest $request
     */
    public $request = null;

    /**
     * @property WishListItemModifyResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                WishListItemModifyRequest::class,
                ['data' => $params]
            )
        );
    ...
    public function setRequest(WishListItemModifyRequest $request)
    {
        $this->request = $request;
        return $this;
    }

    public function getRequest(): WishListItemModifyRequest
    {
        return $this->request;
    }

    public function setResponse(WishListItemModifyResponse $response)
    {
        $this->response = $response;
        return $this;
    }

    public function getResponse(): WishListItemModifyResponse
    {
