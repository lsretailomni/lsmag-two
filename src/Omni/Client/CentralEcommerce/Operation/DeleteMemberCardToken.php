...
use Ls\Omni\Client\CentralEcommerce\Entity\DeleteMemberCardToken as DeleteMemberCardTokenRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\DeleteMemberCardTokenResult as DeleteMemberCardTokenResponse;
...
class DeleteMemberCardToken extends AbstractOperation
{
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                DeleteMemberCardTokenRequest::class,
                ['data' => $params]
            )
        );
