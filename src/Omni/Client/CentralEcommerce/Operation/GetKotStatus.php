...
use Ls\Omni\Client\CentralEcommerce\Entity\GetKotStatus as GetKotStatusRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\GetKotStatusResult as GetKotStatusResponse;

class GetKotStatus extends AbstractOperation
{
    public const OPERATION_NAME = 'GetKotStatus';
    ...
    /**
     * @property GetKotStatusRequest $request
     */
    public $request = null;

    /**
     * @property GetKotStatusResponse $response
     */
    ...
    public function setRequest(GetKotStatusRequest $request)
    {
        $this->request = $request;
        return $this;
    }

    public function getRequest() : GetKotStatusRequest
    {
        return $this->request;
    }

    public function setResponse(GetKotStatusResponse $response)
    {
        $this->response = $response;
        return $this;
    }

    public function getResponse() : GetKotStatusResponse
    {
