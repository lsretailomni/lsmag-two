...
use Ls\Omni\Client\CentralEcommerce\Entity\MemberContactUpdate as MemberContactUpdateRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\MemberContactUpdateResult as MemberContactUpdateResponse;
...
class MemberContactUpdate extends AbstractOperation
{
    ...
    /**
     * @property MemberContactUpdateRequest $request
     */
    public $request = null;

    /**
     * @property MemberContactUpdateResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                MemberContactUpdateRequest::class,
                ['data' => $params]
            )
        );
