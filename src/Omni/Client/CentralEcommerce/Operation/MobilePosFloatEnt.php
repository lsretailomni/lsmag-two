...
use Ls\Omni\Client\CentralEcommerce\Entity\MobilePosFloatEnt as MobilePosFloatEntRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\MobilePosFloatEntResult as MobilePosFloatEntResponse;
...
class MobilePosFloatEnt extends AbstractOperation
{
    ...
    /**
     * @property MobilePosFloatEntRequest $request
     */
    public $request = null;

    /**
     * @property MobilePosFloatEntResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                MobilePosFloatEntRequest::class,
                ['data' => $params]
            )
        );
