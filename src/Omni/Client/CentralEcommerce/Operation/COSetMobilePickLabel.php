...
use Ls\Omni\Client\CentralEcommerce\Entity\COSetMobilePickLabel as COSetMobilePickLabelRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\COSetMobilePickLabelResult as COSetMobilePickLabelResponse;
...
class COSetMobilePickLabel extends AbstractOperation
{
    ...
    /**
     * @property COSetMobilePickLabelRequest $request
     */
    public $request = null;

    /**
     * @property COSetMobilePickLabelResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                COSetMobilePickLabelRequest::class,
                ['data' => $params]
            )
        );
