...
use Ls\Omni\Client\CentralEcommerce\Entity\CreateNewCardForContact as CreateNewCardForContactRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\CreateNewCardForContactResult as CreateNewCardForContactResponse;

class CreateNewCardForContact extends AbstractOperation
{
    public const OPERATION_NAME = 'CreateNewCardForContact';
    ...
    /**
     * @property CreateNewCardForContactRequest $request
     */
    public $request = null;

    /**
     * @property CreateNewCardForContactResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                CreateNewCardForContactRequest::class,
                ['data' => $params]
            )
        );
    ...
    public function setRequest(CreateNewCardForContactRequest $request)
    {
        $this->request = $request;
        return $this;
    }

    public function getRequest() : CreateNewCardForContactRequest
    {
        return $this->request;
    }

    public function setResponse(CreateNewCardForContactResponse $response)
    {
        $this->response = $response;
        return $this;
    }

    public function getResponse() : CreateNewCardForContactResponse
    {
