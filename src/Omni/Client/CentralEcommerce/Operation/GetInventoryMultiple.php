...
use Ls\Omni\Client\CentralEcommerce\Entity\GetInventoryMultiple as GetInventoryMultipleRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\GetInventoryMultipleResult as GetInventoryMultipleResponse;
...
class GetInventoryMultiple extends AbstractOperation
{
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                GetInventoryMultipleRequest::class,
                ['data' => $params]
            )
        );
