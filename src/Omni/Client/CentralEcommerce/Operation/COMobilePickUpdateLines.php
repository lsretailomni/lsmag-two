...
use Ls\Omni\Client\CentralEcommerce\Entity\COMobilePickUpdateLines as COMobilePickUpdateLinesRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\COMobilePickUpdateLinesResult as COMobilePickUpdateLinesResponse;
...
class COMobilePickUpdateLines extends AbstractOperation
{
    ...
    /**
     * @property COMobilePickUpdateLinesRequest $request
     */
    public $request = null;

    /**
     * @property COMobilePickUpdateLinesResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                COMobilePickUpdateLinesRequest::class,
                ['data' => $params]
            )
        );
