...
use Ls\Omni\Client\CentralEcommerce\Entity\CustomerOrderStatus as CustomerOrderStatusRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\CustomerOrderStatusResult as CustomerOrderStatusResponse;
...
class CustomerOrderStatus extends AbstractOperation
{
    ...
    /**
     * @property CustomerOrderStatusRequest $request
     */
    public $request = null;

    /**
     * @property CustomerOrderStatusResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                CustomerOrderStatusRequest::class,
                ['data' => $params]
            )
        );
