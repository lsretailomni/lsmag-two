...
use Ls\Omni\Client\CentralEcommerce\Entity\GetMemberSalesHistory as GetMemberSalesHistoryRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\GetMemberSalesHistoryResult as GetMemberSalesHistoryResponse;
...
class GetMemberSalesHistory extends AbstractOperation
{
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                GetMemberSalesHistoryRequest::class,
                ['data' => $params]
            )
        );
