...
use Ls\Omni\Client\CentralEcommerce\Entity\CustomerOrderGetV3 as CustomerOrderGetV3Request;
use Ls\Omni\Client\CentralEcommerce\Entity\CustomerOrderGetV3Result as CustomerOrderGetV3Response;
...
class CustomerOrderGetV3 extends AbstractOperation
{
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                CustomerOrderGetV3Request::class,
                ['data' => $params]
            )
        );
