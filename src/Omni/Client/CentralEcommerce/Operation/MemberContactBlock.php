...
use Ls\Omni\Client\CentralEcommerce\Entity\MemberContactBlock as MemberContactBlockRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\MemberContactBlockResult as MemberContactBlockResponse;
...
class MemberContactBlock extends AbstractOperation
{
    ...
    /**
     * @property MemberContactBlockRequest $request
     */
    public $request = null;

    /**
     * @property MemberContactBlockResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                MemberContactBlockRequest::class,
                ['data' => $params]
            )
        );
