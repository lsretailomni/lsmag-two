...
use Ls\Omni\Client\CentralEcommerce\Entity\GetDocumentList as GetDocumentListRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\GetDocumentListResult as GetDocumentListResponse;
...
class GetDocumentList extends AbstractOperation
{
    ...
    public function setRequest(GetDocumentListRequest $request)
    {
        $this->request = $request;
        return $this;
    }

    public function getRequest() : GetDocumentListRequest
    {
        return $this->request;
    }

    public function setResponse(GetDocumentListResponse $response)
    {
        $this->response = $response;
        return $this;
    }

    public function getResponse() : GetDocumentListResponse
    {
