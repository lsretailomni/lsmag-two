...
use Ls\Omni\Client\CentralEcommerce\Entity\GetASNDocumentList as GetASNDocumentListRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\GetASNDocumentListResult as GetASNDocumentListResponse;
...
class GetASNDocumentList extends AbstractOperation
{
    ...
    /**
     * @property GetASNDocumentListRequest $request
     */
    public $request = null;

    /**
     * @property GetASNDocumentListResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                GetASNDocumentListRequest::class,
                ['data' => $params]
            )
        );
