...
use Ls\Omni\Client\CentralEcommerce\Entity\GetItemWithBarcode as GetItemWithBarcodeRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\GetItemWithBarcodeResult as GetItemWithBarcodeResponse;
...
class GetItemWithBarcode extends AbstractOperation
{
    ...
    /**
     * @property GetItemWithBarcodeRequest $request
     */
    public $request = null;

    /**
     * @property GetItemWithBarcodeResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                GetItemWithBarcodeRequest::class,
                ['data' => $params]
            )
        );
