...
use Ls\Omni\Client\CentralEcommerce\Entity\WishListCreate as WishListCreateRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\WishListCreateResult as WishListCreateResponse;

class WishListCreate extends AbstractOperation
{
    public const OPERATION_NAME = 'WishListCreate';
    ...
    /**
     * @property WishListCreateRequest $request
     */
    public $request = null;

    /**
     * @property WishListCreateResponse $response
     */
    ...
    public function setRequest(WishListCreateRequest $request)
    {
        $this->request = $request;
        return $this;
    }

    public function getRequest(): WishListCreateRequest
    {
        return $this->request;
    }

    public function setResponse(WishListCreateResponse $response)
    {
        $this->response = $response;
        return $this;
    }

    public function getResponse(): WishListCreateResponse
    {
