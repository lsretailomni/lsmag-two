...
use Ls\Omni\Client\CentralEcommerce\Entity\SendASNScannedLines as SendASNScannedLinesRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\SendASNScannedLinesResult as SendASNScannedLinesResponse;
...
class SendASNScannedLines extends AbstractOperation
{
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                SendASNScannedLinesRequest::class,
                ['data' => $params]
            )
        );
