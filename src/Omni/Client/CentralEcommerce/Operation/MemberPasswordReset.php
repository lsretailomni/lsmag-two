...
use Ls\Omni\Client\CentralEcommerce\Entity\MemberPasswordReset as MemberPasswordResetRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\MemberPasswordResetResult as MemberPasswordResetResponse;

class MemberPasswordReset extends AbstractOperation
{
    public const OPERATION_NAME = 'MemberPasswordReset';
    ...
    /**
     * @property MemberPasswordResetRequest $request
     */
    public $request = null;

    /**
     * @property MemberPasswordResetResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                MemberPasswordResetRequest::class,
                ['data' => $params]
            )
        );
    ...
    public function setRequest(MemberPasswordResetRequest $request)
    {
        $this->request = $request;
        return $this;
    }

    public function getRequest() : MemberPasswordResetRequest
    {
        return $this->request;
    }

    public function setResponse(MemberPasswordResetResponse $response)
    {
        $this->response = $response;
        return $this;
    }

    public function getResponse() : MemberPasswordResetResponse
    {
