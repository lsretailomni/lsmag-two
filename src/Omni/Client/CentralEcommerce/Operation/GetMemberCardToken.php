...
use Ls\Omni\Client\CentralEcommerce\Entity\GetMemberCardToken as GetMemberCardTokenRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\GetMemberCardTokenResult as GetMemberCardTokenResponse;
...
class GetMemberCardToken extends AbstractOperation
{
    ...
    /**
     * @property GetMemberCardTokenRequest $request
     */
    public $request = null;

    /**
     * @property GetMemberCardTokenResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                GetMemberCardTokenRequest::class,
                ['data' => $params]
            )
        );
