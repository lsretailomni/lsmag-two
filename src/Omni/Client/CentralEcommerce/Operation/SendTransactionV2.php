...
use Ls\Omni\Client\CentralEcommerce\Entity\SendTransactionV2 as SendTransactionV2Request;
use Ls\Omni\Client\CentralEcommerce\Entity\SendTransactionV2Result as SendTransactionV2Response;
...
class SendTransactionV2 extends AbstractOperation
{
    ...
    /**
     * @property SendTransactionV2Request $request
     */
    public $request = null;

    /**
     * @property SendTransactionV2Response $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                SendTransactionV2Request::class,
                ['data' => $params]
            )
        );
