...
use Ls\Omni\Client\CentralEcommerce\Entity\StoreInvTransactionSend as StoreInvTransactionSendRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\StoreInvTransactionSendResult as StoreInvTransactionSendResponse;
...
class StoreInvTransactionSend extends AbstractOperation
{
    ...
    /**
     * @property StoreInvTransactionSendRequest $request
     */
    public $request = null;

    /**
     * @property StoreInvTransactionSendResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                StoreInvTransactionSendRequest::class,
                ['data' => $params]
            )
        );
