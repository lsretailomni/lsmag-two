...
use Ls\Omni\Client\CentralEcommerce\Entity\CustomerOrderCancelResult as CustomerOrderCancelResponse;
...
class CustomerOrderCancel extends AbstractOperation
{
    ...
    /**
     * @property CustomerOrderCancelRequest $request
     */
    public $request = null;

    /**
     * @property CustomerOrderCancelResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                CustomerOrderCancelRequest::class,
                ['data' => $params]
            )
        );
