...
use Ls\Omni\Client\CentralEcommerce\Entity\GetTokenEntry as GetTokenEntryRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\GetTokenEntryResult as GetTokenEntryResponse;
...
class GetTokenEntry extends AbstractOperation
{
    ...
    /**
     * @property GetTokenEntryRequest $request
     */
    public $request = null;

    /**
     * @property GetTokenEntryResponse $response
     */
