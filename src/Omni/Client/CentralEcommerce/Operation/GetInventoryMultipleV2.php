...
use Ls\Omni\Client\CentralEcommerce\Entity\GetInventoryMultipleV2 as GetInventoryMultipleV2Request;
use Ls\Omni\Client\CentralEcommerce\Entity\GetInventoryMultipleV2Result as GetInventoryMultipleV2Response;
...
class GetInventoryMultipleV2 extends AbstractOperation
{
    ...
    /**
     * @property GetInventoryMultipleV2Request $request
     */
    public $request = null;

    /**
     * @property GetInventoryMultipleV2Response $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                GetInventoryMultipleV2Request::class,
                ['data' => $params]
            )
        );
