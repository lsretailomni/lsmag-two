...
use Ls\Omni\Client\CentralEcommerce\Entity\SendTransactionHeader as SendTransactionHeaderRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\SendTransactionHeaderResult as SendTransactionHeaderResponse;
...
class SendTransactionHeader extends AbstractOperation
{
    ...
    /**
     * @property SendTransactionHeaderRequest $request
     */
    public $request = null;

    /**
     * @property SendTransactionHeaderResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                SendTransactionHeaderRequest::class,
                ['data' => $params]
            )
        );
