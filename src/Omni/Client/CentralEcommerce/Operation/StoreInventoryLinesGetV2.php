...
use Ls\Omni\Client\CentralEcommerce\Entity\StoreInventoryLinesGetV2 as StoreInventoryLinesGetV2Request;
use Ls\Omni\Client\CentralEcommerce\Entity\StoreInventoryLinesGetV2Result as StoreInventoryLinesGetV2Response;
...
class StoreInventoryLinesGetV2 extends AbstractOperation
{
    ...
    /**
     * @property StoreInventoryLinesGetV2Request $request
     */
    public $request = null;

    /**
     * @property StoreInventoryLinesGetV2Response $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                StoreInventoryLinesGetV2Request::class,
                ['data' => $params]
            )
        );
