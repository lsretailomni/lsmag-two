...
use Ls\Omni\Client\CentralEcommerce\Entity\GetDocumentListV2 as GetDocumentListV2Request;
use Ls\Omni\Client\CentralEcommerce\Entity\GetDocumentListV2Result as GetDocumentListV2Response;
...
class GetDocumentListV2 extends AbstractOperation
{
    ...
    /**
     * @property GetDocumentListV2Request $request
     */
    public $request = null;

    /**
     * @property GetDocumentListV2Response $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                GetDocumentListV2Request::class,
                ['data' => $params]
            )
        );
