...
use Ls\Omni\Client\CentralEcommerce\Entity\CancelHospOrderResult as CancelHospOrderResponse;
...
class CancelHospOrder extends AbstractOperation
{
    ...
    /**
     * @property CancelHospOrderRequest $request
     */
    public $request = null;

    /**
     * @property CancelHospOrderResponse $response
     */
