...
use Ls\Omni\Client\CentralEcommerce\Entity\MobilePosSalesHistory as MobilePosSalesHistoryRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\MobilePosSalesHistoryResult as MobilePosSalesHistoryResponse;
...
class MobilePosSalesHistory extends AbstractOperation
{
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                MobilePosSalesHistoryRequest::class,
                ['data' => $params]
            )
        );
