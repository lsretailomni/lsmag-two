...
use Ls\Omni\Client\CentralEcommerce\Entity\GetASNDocumentLines as GetASNDocumentLinesRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\GetASNDocumentLinesResult as GetASNDocumentLinesResponse;
...
class GetASNDocumentLines extends AbstractOperation
{
    ...
    /**
     * @property GetASNDocumentLinesRequest $request
     */
    public $request = null;

    /**
     * @property GetASNDocumentLinesResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                GetASNDocumentLinesRequest::class,
                ['data' => $params]
            )
        );
