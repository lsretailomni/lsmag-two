...
use Ls\Omni\Client\CentralEcommerce\Entity\COQtyAvailabilityV2 as COQtyAvailabilityV2Request;
use Ls\Omni\Client\CentralEcommerce\Entity\COQtyAvailabilityV2Result as COQtyAvailabilityV2Response;
...
class COQtyAvailabilityV2 extends AbstractOperation
{
    ...
    /**
     * @property COQtyAvailabilityV2Request $request
     */
    public $request = null;

    /**
     * @property COQtyAvailabilityV2Response $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                COQtyAvailabilityV2Request::class,
                ['data' => $params]
            )
        );
