...
use Ls\Omni\Client\CentralEcommerce\Entity\GetReturnPolicy as GetReturnPolicyRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\GetReturnPolicyResult as GetReturnPolicyResponse;
...
class GetReturnPolicy extends AbstractOperation
{
    ...
    /**
     * @property GetReturnPolicyRequest $request
     */
    public $request = null;

    /**
     * @property GetReturnPolicyResponse $response
     */
