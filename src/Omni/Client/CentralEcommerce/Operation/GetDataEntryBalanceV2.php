...
use Ls\Omni\Client\CentralEcommerce\Entity\GetDataEntryBalanceV2 as GetDataEntryBalanceV2Request;
use Ls\Omni\Client\CentralEcommerce\Entity\GetDataEntryBalanceV2Result as GetDataEntryBalanceV2Response;
...
class GetDataEntryBalanceV2 extends AbstractOperation
{
    ...
    /**
     * @property GetDataEntryBalanceV2Request $request
     */
    public $request = null;

    /**
     * @property GetDataEntryBalanceV2Response $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                GetDataEntryBalanceV2Request::class,
                ['data' => $params]
            )
        );
