...
use Ls\Omni\Client\CentralEcommerce\Entity\SendDocumentImage as SendDocumentImageRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\SendDocumentImageResult as SendDocumentImageResponse;
...
class SendDocumentImage extends AbstractOperation
{
    ...
    /**
     * @property SendDocumentImageRequest $request
     */
    public $request = null;

    /**
     * @property SendDocumentImageResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                SendDocumentImageRequest::class,
                ['data' => $params]
            )
        );
