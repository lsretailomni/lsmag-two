...
use Ls\Omni\Client\CentralEcommerce\Entity\LSCSalesShipmentGet as LSCSalesShipmentGetRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\LSCSalesShipmentGetResult as LSCSalesShipmentGetResponse;
...
class LSCSalesShipmentGet extends AbstractOperation
{
    ...
    /**
     * @property LSCSalesShipmentGetRequest $request
     */
    public $request = null;

    /**
     * @property LSCSalesShipmentGetResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                LSCSalesShipmentGetRequest::class,
                ['data' => $params]
            )
        );
