...
use Ls\Omni\Client\CentralEcommerce\Entity\CustomerOrderCreateV5 as CustomerOrderCreateV5Request;
use Ls\Omni\Client\CentralEcommerce\Entity\CustomerOrderCreateV5Result as CustomerOrderCreateV5Response;
...
class CustomerOrderCreateV5 extends AbstractOperation
{
    ...
    /**
     * @property CustomerOrderCreateV5Request $request
     */
    public $request = null;

    /**
     * @property CustomerOrderCreateV5Response $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                CustomerOrderCreateV5Request::class,
                ['data' => $params]
            )
        );
