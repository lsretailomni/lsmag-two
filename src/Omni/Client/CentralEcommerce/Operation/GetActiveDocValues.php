...
use Ls\Omni\Client\CentralEcommerce\Entity\GetActiveDocValues as GetActiveDocValuesRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\GetActiveDocValuesResult as GetActiveDocValuesResponse;
...
class GetActiveDocValues extends AbstractOperation
{
    ...
    /**
     * @property GetActiveDocValuesRequest $request
     */
    public $request = null;

    /**
     * @property GetActiveDocValuesResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                GetActiveDocValuesRequest::class,
                ['data' => $params]
            )
        );
