...
class LSCSTAFFStoreLink
{
    ...
    public \Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetStoreStaff $request;
    public \Ls\Omni\Client\CentralEcommerce\Entity\LSCSTAFFStoreLinkResponse $response;
    ...
    public function __construct($baseUrl = '', $connectionParams = [], $companyName = '')
    {
        ...
        $this->request = $this->createInstance(\Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetStoreStaff::class);
    }

    public function execute(): \Ls\Omni\Client\CentralEcommerce\Entity\LSCSTAFFStoreLinkResponse
    {
        $response = $this->dataHelper->makeRequest(
            \Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetStoreStaff::ACTION_NAME,
            \Ls\Omni\Client\CentralEcommerce\Entity\LSCSTAFFStoreLink::class,
            $this->request,
            $this->baseUrl,
    ...
    public function formatResponse($data): \Ls\Omni\Client\CentralEcommerce\Entity\LSCSTAFFStoreLinkResponse
    {
        ...
        return $this->createInstance(
                    \Ls\Omni\Client\CentralEcommerce\Entity\LSCSTAFFStoreLinkResponse::class,
                     [
                        'data' => [
                        'records' => $results,
                        'status' => $data['Status'] ?? '',
    ...
    public function & setOperationInput(array $params = []): \Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetStoreStaff
    {
        $this->setRequest(
            $this->createInstance(
                \Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetStoreStaff::class,
                ['data' => $params]
            )
        );
    ...
    public function setRequest(\Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetStoreStaff $request): self
    {
        $this->request = $request;
        return $this;
    }

    public function setResponse(\Ls\Omni\Client\CentralEcommerce\Entity\LSCSTAFFStoreLinkResponse $response): self
    {
        $this->response = $response;
        return $this;
    }

    public function getRequest(): \Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetStoreStaff
    {
        return $this->request;
    }

    public function getResponse(): \Ls\Omni\Client\CentralEcommerce\Entity\LSCSTAFFStoreLinkResponse
    {
