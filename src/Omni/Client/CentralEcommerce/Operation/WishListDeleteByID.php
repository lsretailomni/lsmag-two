...
use Ls\Omni\Client\CentralEcommerce\Entity\WishListDeleteByID as WishListDeleteByIDRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\WishListDeleteByIDResult as WishListDeleteByIDResponse;

class WishListDeleteByID extends AbstractOperation
{
    public const OPERATION_NAME = 'WishListDeleteByID';
    ...
    /**
     * @property WishListDeleteByIDRequest $request
     */
    public $request = null;

    /**
     * @property WishListDeleteByIDResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                WishListDeleteByIDRequest::class,
                ['data' => $params]
            )
        );
    ...
    public function setRequest(WishListDeleteByIDRequest $request)
    {
        $this->request = $request;
        return $this;
    }

    public function getRequest(): WishListDeleteByIDRequest
    {
        return $this->request;
    }

    public function setResponse(WishListDeleteByIDResponse $response)
    {
        $this->response = $response;
        return $this;
    }

    public function getResponse(): WishListDeleteByIDResponse
    {
