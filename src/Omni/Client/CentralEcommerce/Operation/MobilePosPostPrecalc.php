...
use Ls\Omni\Client\CentralEcommerce\Entity\MobilePosPostPrecalc as MobilePosPostPrecalcRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\MobilePosPostPrecalcResult as MobilePosPostPrecalcResponse;
...
class MobilePosPostPrecalc extends AbstractOperation
{
    ...
    /**
     * @property MobilePosPostPrecalcRequest $request
     */
    public $request = null;

    /**
     * @property MobilePosPostPrecalcResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                MobilePosPostPrecalcRequest::class,
                ['data' => $params]
            )
        );
