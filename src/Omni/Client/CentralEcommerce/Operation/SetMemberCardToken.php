...
use Ls\Omni\Client\CentralEcommerce\Entity\SetMemberCardToken as SetMemberCardTokenRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\SetMemberCardTokenResult as SetMemberCardTokenResponse;
...
class SetMemberCardToken extends AbstractOperation
{
    ...
    /**
     * @property SetMemberCardTokenRequest $request
     */
    public $request = null;

    /**
     * @property SetMemberCardTokenResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                SetMemberCardTokenRequest::class,
                ['data' => $params]
            )
        );
