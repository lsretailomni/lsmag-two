...
use Ls\Omni\Client\CentralEcommerce\Entity\MobilePosGetDeviceID as MobilePosGetDeviceIDRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\MobilePosGetDeviceIDResult as MobilePosGetDeviceIDResponse;
...
class MobilePosGetDeviceID extends AbstractOperation
{
    ...
    /**
     * @property MobilePosGetDeviceIDRequest $request
     */
    public $request = null;

    /**
     * @property MobilePosGetDeviceIDResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                MobilePosGetDeviceIDRequest::class,
                ['data' => $params]
            )
        );
