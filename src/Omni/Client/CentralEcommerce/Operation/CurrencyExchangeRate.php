...
class CurrencyExchangeRate
{
    ...
    public \Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetCurrencyExchRate $request;
    public \Ls\Omni\Client\CentralEcommerce\Entity\CurrencyExchangeRateResponse $response;
    ...
    public function __construct($baseUrl = '', $connectionParams = [], $companyName = '')
    {
        ...
        $this->request = $this->createInstance(\Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetCurrencyExchRate::class);
    }

    public function execute(): \Ls\Omni\Client\CentralEcommerce\Entity\CurrencyExchangeRateResponse
    {
        $response = $this->dataHelper->makeRequest(
            \Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetCurrencyExchRate::ACTION_NAME,
            \Ls\Omni\Client\CentralEcommerce\Entity\CurrencyExchangeRate::class,
            $this->request,
            $this->baseUrl,
    ...
    public function formatResponse($data): \Ls\Omni\Client\CentralEcommerce\Entity\CurrencyExchangeRateResponse
    {
        ...
        return $this->createInstance(
                    \Ls\Omni\Client\CentralEcommerce\Entity\CurrencyExchangeRateResponse::class,
                     [
                        'data' => [
                        'records' => $results,
                        'status' => $data['Status'] ?? '',
    ...
    public function & setOperationInput(array $params = []): \Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetCurrencyExchRate
    {
        $this->setRequest(
            $this->createInstance(
                \Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetCurrencyExchRate::class,
                ['data' => $params]
            )
        );
    ...
    public function setRequest(\Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetCurrencyExchRate $request): self
    {
        $this->request = $request;
        return $this;
    }

    public function setResponse(\Ls\Omni\Client\CentralEcommerce\Entity\CurrencyExchangeRateResponse $response): self
    {
        $this->response = $response;
        return $this;
    }

    public function getRequest(): \Ls\Omni\Client\CentralEcommerce\Entity\ODataRequest_GetCurrencyExchRate
    {
        return $this->request;
    }

    public function getResponse(): \Ls\Omni\Client\CentralEcommerce\Entity\CurrencyExchangeRateResponse
    {
