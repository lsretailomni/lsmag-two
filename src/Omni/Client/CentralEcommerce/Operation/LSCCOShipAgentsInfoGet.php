...
use Ls\Omni\Client\CentralEcommerce\Entity\LSCCOShipAgentsInfoGet as LSCCOShipAgentsInfoGetRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\LSCCOShipAgentsInfoGetResult as LSCCOShipAgentsInfoGetResponse;
...
class LSCCOShipAgentsInfoGet extends AbstractOperation
{
    ...
    /**
     * @property LSCCOShipAgentsInfoGetRequest $request
     */
    public $request = null;

    /**
     * @property LSCCOShipAgentsInfoGetResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                LSCCOShipAgentsInfoGetRequest::class,
                ['data' => $params]
            )
        );
