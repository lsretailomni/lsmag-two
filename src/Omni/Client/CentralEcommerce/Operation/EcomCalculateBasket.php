...
use Ls\Omni\Client\CentralEcommerce\Entity\EcomCalculateBasket as EcomCalculateBasketRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\EcomCalculateBasketResult as EcomCalculateBasketResponse;
...
class EcomCalculateBasket extends AbstractOperation
{
    ...
    /**
     * @property EcomCalculateBasketRequest $request
     */
    public $request = null;

    /**
     * @property EcomCalculateBasketResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                EcomCalculateBasketRequest::class,
                ['data' => $params]
            )
        );
