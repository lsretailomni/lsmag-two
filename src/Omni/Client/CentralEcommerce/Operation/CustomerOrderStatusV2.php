...
use Ls\Omni\Client\CentralEcommerce\Entity\CustomerOrderStatusV2 as CustomerOrderStatusV2Request;
use Ls\Omni\Client\CentralEcommerce\Entity\CustomerOrderStatusV2Result as CustomerOrderStatusV2Response;
...
class CustomerOrderStatusV2 extends AbstractOperation
{
    ...
    /**
     * @property CustomerOrderStatusV2Request $request
     */
    public $request = null;

    /**
     * @property CustomerOrderStatusV2Response $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                CustomerOrderStatusV2Request::class,
                ['data' => $params]
            )
        );
