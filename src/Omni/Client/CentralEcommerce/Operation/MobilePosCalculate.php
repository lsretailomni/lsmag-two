...
use Ls\Omni\Client\CentralEcommerce\Entity\MobilePosCalculate as MobilePosCalculateRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\MobilePosCalculateResult as MobilePosCalculateResponse;
...
class MobilePosCalculate extends AbstractOperation
{
    ...
    /**
     * @property MobilePosCalculateRequest $request
     */
    public $request = null;

    /**
     * @property MobilePosCalculateResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                MobilePosCalculateRequest::class,
                ['data' => $params]
            )
        );
