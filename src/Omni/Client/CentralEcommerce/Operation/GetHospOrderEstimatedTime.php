...
use Ls\Omni\Client\CentralEcommerce\Entity\GetHospOrderEstimatedTime as GetHospOrderEstimatedTimeRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\GetHospOrderEstimatedTimeResult as GetHospOrderEstimatedTimeResponse;
...
class GetHospOrderEstimatedTime extends AbstractOperation
{
    ...
    /**
     * @property GetHospOrderEstimatedTimeRequest $request
     */
    public $request = null;

    /**
     * @property GetHospOrderEstimatedTimeResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                GetHospOrderEstimatedTimeRequest::class,
                ['data' => $params]
            )
        );
