...
use Ls\Omni\Client\CentralEcommerce\Entity\MobilelPosGetLastReceiptNo as MobilelPosGetLastReceiptNoRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\MobilelPosGetLastReceiptNoResult as MobilelPosGetLastReceiptNoResponse;
...
class MobilelPosGetLastReceiptNo extends AbstractOperation
{
    ...
    /**
     * @property MobilelPosGetLastReceiptNoRequest $request
     */
    public $request = null;

    /**
     * @property MobilelPosGetLastReceiptNoResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                MobilelPosGetLastReceiptNoRequest::class,
                ['data' => $params]
            )
        );
