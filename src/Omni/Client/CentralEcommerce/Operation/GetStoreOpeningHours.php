...
use Ls\Omni\Client\CentralEcommerce\Entity\GetStoreOpeningHours as GetStoreOpeningHoursRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\GetStoreOpeningHoursResult as GetStoreOpeningHoursResponse;
...
class GetStoreOpeningHours extends AbstractOperation
{
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                GetStoreOpeningHoursRequest::class,
                ['data' => $params]
            )
        );
