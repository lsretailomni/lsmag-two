...
use Ls\Omni\Client\CentralEcommerce\Entity\CustomerOrderEditV2 as CustomerOrderEditV2Request;
use Ls\Omni\Client\CentralEcommerce\Entity\CustomerOrderEditV2Result as CustomerOrderEditV2Response;

class CustomerOrderEditV2 extends AbstractOperation
{
    public const OPERATION_NAME = 'CustomerOrderEditV2';
    ...
    /**
     * @property CustomerOrderEditV2Request $request
     */
    public $request = null;

    /**
     * @property CustomerOrderEditV2Response $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                CustomerOrderEditV2Request::class,
                ['data' => $params]
            )
        );
    ...
    public function setRequest(CustomerOrderEditV2Request $request)
    {
        $this->request = $request;
        return $this;
    }

    public function getRequest(): CustomerOrderEditV2Request
    {
        return $this->request;
    }

    public function setResponse(CustomerOrderEditV2Response $response)
    {
        $this->response = $response;
        return $this;
    }

    public function getResponse(): CustomerOrderEditV2Response
    {
