...
use Ls\Omni\Client\CentralEcommerce\Entity\GetActionsFromRemoteDB as GetActionsFromRemoteDBRequest;
use Ls\Omni\Client\CentralEcommerce\Entity\GetActionsFromRemoteDBResult as GetActionsFromRemoteDBResponse;
...
class GetActionsFromRemoteDB extends AbstractOperation
{
    ...
    /**
     * @property GetActionsFromRemoteDBRequest $request
     */
    public $request = null;

    /**
     * @property GetActionsFromRemoteDBResponse $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                GetActionsFromRemoteDBRequest::class,
                ['data' => $params]
            )
        );
