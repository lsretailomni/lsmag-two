...
use Ls\Omni\Client\CentralEcommerce\Entity\MobilePosCalculateV2 as MobilePosCalculateV2Request;
use Ls\Omni\Client\CentralEcommerce\Entity\MobilePosCalculateV2Result as MobilePosCalculateV2Response;
...
class MobilePosCalculateV2 extends AbstractOperation
{
    ...
    /**
     * @property MobilePosCalculateV2Request $request
     */
    public $request = null;

    /**
     * @property MobilePosCalculateV2Response $response
     */
    ...
    public function & setOperationInput(array $params = [])
    {
        $this->setRequest(
            $this->createInstance(
                MobilePosCalculateV2Request::class,
                ['data' => $params]
            )
        );
