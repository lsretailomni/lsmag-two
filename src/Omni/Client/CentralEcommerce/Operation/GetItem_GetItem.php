...
class GetItem_GetItem
{
    ...
    public \Ls\Omni\Client\CentralEcommerce\Entity\GetItem_GetItemRequest $request;
    public \Ls\Omni\Client\CentralEcommerce\Entity\GetItem_GetItemResponse $response;
    ...
    public function __construct(string $baseUrl = '', array $connectionParams = [], string $companyName = '')
    {
        ...
        $this->request = $this->createInstance(\Ls\Omni\Client\CentralEcommerce\Entity\GetItem_GetItemRequest::class);
    }

    public function execute(): \Ls\Omni\Client\CentralEcommerce\Entity\GetItem_GetItemResponse
    {
        $raw = $this->dataHelper->makeRequest(
            \Ls\Omni\Client\CentralEcommerce\Entity\GetItem_GetItemRequest::ACTION_NAME,
            self::class,
            $this->request,
            $this->baseUrl,
    ...
    public function formatResponse($data): \Ls\Omni\Client\CentralEcommerce\Entity\GetItem_GetItemResponse
    {
        ...
        $finalEntry = $this->createInstance(\Ls\Omni\Client\CentralEcommerce\Entity\GetItem_GetItem::class);
            ...
            foreach ($requiredDataSetName as $dataSet) {
                ...
                if (isset($data[$dataSet]) && is_array($data[$dataSet])) {
                    $entity = $this->createInstance(
                        \Ls\Omni\Client\CentralEcommerce\Entity\GetItem_GetItem::class,
                    ...
                    return $this->createInstance(
                        \Ls\Omni\Client\CentralEcommerce\Entity\GetItem_GetItemResponse::class,
                       [
                       'data' =>
                           [
                                'records' => [$entity],
    ...
    public function & setOperationInput(array $params = []): \Ls\Omni\Client\CentralEcommerce\Entity\GetItem_GetItemRequest
    {
        $this->setRequest(
            $this->createInstance(
                \Ls\Omni\Client\CentralEcommerce\Entity\GetItem_GetItemRequest::class,
                ['data' => $params]
            )
        );
    ...
    public function setRequest(\Ls\Omni\Client\CentralEcommerce\Entity\GetItem_GetItemRequest $request): self
    {
        $this->request = $request;
        return $this;
    }

    public function setResponse(\Ls\Omni\Client\CentralEcommerce\Entity\GetItem_GetItemResponse $response): self
    {
        $this->response = $response;
        return $this;
    }

    public function getRequest(): \Ls\Omni\Client\CentralEcommerce\Entity\GetItem_GetItemRequest
    {
        return $this->request;
    }

    public function getResponse(): \Ls\Omni\Client\CentralEcommerce\Entity\GetItem_GetItemResponse
    {
