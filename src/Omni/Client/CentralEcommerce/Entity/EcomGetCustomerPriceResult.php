...
class EcomGetCustomerPriceResult extends \Magento\Catalog\Model\AbstractModel implements ResponseInterface
{
    public const CLASS_NAME = 'EcomGetCustomerPrice_Result';
