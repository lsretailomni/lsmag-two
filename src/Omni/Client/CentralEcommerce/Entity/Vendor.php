...
class Vendor extends AbstractModel
{
    ...
    public const CARBON_PRICING_PAID = 'Carbon Pricing Paid';
	...
	self::CARBON_PRICING_PAID => 'carbon_pricing_paid',
    ...
    public function getCarbonPricingPaid(): ?bool
    {
        return $this->getData(self::CARBON_PRICING_PAID);
    }

    public function setCarbonPricingPaid(?bool $value)
    {
        return $this->setData(self::CARBON_PRICING_PAID, $value);
    }
