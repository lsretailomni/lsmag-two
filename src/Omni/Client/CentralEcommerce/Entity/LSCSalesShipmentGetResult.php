...
class LSCSalesShipmentGetResult extends \Magento\Catalog\Model\AbstractModel implements ResponseInterface
{
    public const CLASS_NAME = 'LSCSalesShipmentGet_Result';
