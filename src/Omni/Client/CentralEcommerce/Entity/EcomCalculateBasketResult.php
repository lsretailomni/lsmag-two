...
class EcomCalculateBasketResult extends \Magento\Catalog\Model\AbstractModel implements ResponseInterface
{
    public const CLASS_NAME = 'EcomCalculateBasket_Result';
