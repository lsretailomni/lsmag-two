...
class MemberContactUpdateResult extends \Magento\Catalog\Model\AbstractModel implements ResponseInterface
{
    public const CLASS_NAME = 'MemberContactUpdate_Result';
