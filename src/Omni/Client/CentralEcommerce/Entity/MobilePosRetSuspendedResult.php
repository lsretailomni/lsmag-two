...
class MobilePosRetSuspendedResult extends \Magento\Catalog\Model\AbstractModel implements ResponseInterface
{
    public const CLASS_NAME = 'MobilePosRetSuspended_Result';
