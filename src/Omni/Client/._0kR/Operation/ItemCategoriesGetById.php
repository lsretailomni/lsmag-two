...
use Ls\Omni\Client\Ecommerce\Entity\ItemCategoriesGetById as ItemCategoriesGetByIdRequest;
use Ls\Omni\Client\Ecommerce\Entity\ItemCategoriesGetByIdResponse as ItemCategoriesGetByIdResponse;

class ItemCategoriesGetById extends AbstractOperation
{
    public const OPERATION_NAME = 'ITEM_CATEGORIES_GET_BY_ID';
