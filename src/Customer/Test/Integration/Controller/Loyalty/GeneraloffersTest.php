...
class GeneraloffersTest extends AbstractController
{
    ...
    #[
        ...
        Config(LSR::SC_LOYALTY_SHOW_GENERAL_OFFERS, AbstractIntegrationTest::ENABLED, 'store', 'default'),
        Config(LSR::SC_LOYALTY_SHOW_GENERAL_OFFERS, AbstractIntegrationTest::ENABLED, 'website'),
        DataFixture(
    ...
    public function testExecuteWithRequiredConfigurations()
    {
        ...
        $this->dispatch('customer/loyalty/generaloffers');
        $content = $this->getResponse()->getBody();
        $this->assertStringContainsString('General Offers', $content);
    }
    ...
    #[
        ...
        Config(LSR::SC_SERVICE_LS_CENTRAL_VERSION, AbstractIntegrationTest::LS_VERSION, 'website'),
        Config(LSR::SC_SERVICE_LS_CENTRAL_VERSION, AbstractIntegrationTest::LS_VERSION, 'store', 'default'),
        Config(LSR::SC_LOYALTY_SHOW_GENERAL_OFFERS, 0, 'store', 'default'),
        Config(LSR::SC_LOYALTY_SHOW_GENERAL_OFFERS, 0, 'website'),
        DataFixture(
            CustomerFixture::class,
            [
                'lsr_username' => AbstractIntegrationTest::USERNAME,
