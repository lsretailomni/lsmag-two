...
class CouponsTest extends AbstractController
{
    ...
    #[
        ...
        Config(LSR::SC_LOYALTY_SHOW_COUPON_OFFERS, AbstractIntegrationTest::ENABLED, 'store', 'default'),
        Config(LSR::SC_LOYALTY_SHOW_COUPON_OFFERS, AbstractIntegrationTest::ENABLED, 'website'),
        DataFixture(
    ...
    public function testExecuteWithRequiredConfigurations()
    {
        ...
        $this->dispatch('customer/loyalty/coupons');
        $content = $this->getResponse()->getBody();
        $this->assertStringContainsString('Coupon Offers', $content);
    }
