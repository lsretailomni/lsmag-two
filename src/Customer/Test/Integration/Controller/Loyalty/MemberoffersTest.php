...
class MemberoffersTest extends AbstractController
{
    ...
    #[
        ...
        Config(LSR::SC_LOYALTY_SHOW_MEMBER_OFFERS, AbstractIntegrationTest::ENABLED, 'store', 'default'),
        Config(LSR::SC_LOYALTY_SHOW_MEMBER_OFFERS, AbstractIntegrationTest::ENABLED, 'website'),
    ...
    public function testExecuteWithRequiredConfigurations()
    {
        ...
        $this->dispatch('customer/loyalty/memberoffers');
        $content = $this->getResponse()->getBody();
        $this->assertStringContainsString('Member Offers', $content);
    }
    ...
    #[
        ...
        Config(LSR::SC_SERVICE_LS_CENTRAL_VERSION, AbstractIntegrationTest::LS_VERSION, 'website'),
        Config(LSR::SC_SERVICE_LS_CENTRAL_VERSION, AbstractIntegrationTest::LS_VERSION, 'store', 'default'),
        Config(LSR::SC_LOYALTY_SHOW_MEMBER_OFFERS, 0, 'store', 'default'),
        Config(LSR::SC_LOYALTY_SHOW_MEMBER_OFFERS, 0, 'website'),
        Config(LSR::SC_SERVICE_DEBUG, AbstractIntegrationTest::ENABLED, 'website'),
        Config(LSR::SC_SERVICE_DEBUG, AbstractIntegrationTest::ENABLED, 'store', 'default'),
        DataFixture(
            CustomerFixture::class,
