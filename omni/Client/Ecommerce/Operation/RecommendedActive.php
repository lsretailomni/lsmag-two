...
class RecommendedActive extends AbstractOperation implements IOperation
{

    const OPERATION_NAME = 'RECOMMENDED_ACTIVE';
    ...
    /** @noinspection PhpDocSignatureInspection */
	/**
     * @property RecommendedActiveRequest $request_xml
     */
    private $request_xml = null;

    /** @noinspection PhpDocSignatureInspection */
	/**
     * @property RecommendedActiveResponse $response_xml
     */
     ...
     * @return IResponse|RecommendedActiveResponse
     */
    ...
    /** @noinspection PhpDocSignatureInspection */
	/**
     * @param RecommendedActiveRequest $request_xml
     * @return $this
     */
    ...
    /** @noinspection PhpDocSignatureInspection */
	/**
     * @param RecommendedActiveResponse $response_xml
     * @return $this
     */
