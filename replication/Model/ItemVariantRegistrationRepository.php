...
class ItemVariantRegistrationRepository implements ItemVariantRegistrationRepositoryInterface
{

    /**
     * @property ItemVariantRegistrationFactory $object_factory
     */
    ...
    public function __construct(ItemVariantRegistrationFactory $object_factory, CollectionFactory $collection_factory, SearchResultInterfaceFactory $result_factory)
    {
    ...
    public function save(ItemVariantRegistrationInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ItemVariantRegistrationInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
