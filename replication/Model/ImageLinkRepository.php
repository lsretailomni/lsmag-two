...
class ImageLinkRepository implements ImageLinkRepositoryInterface
{

    /**
     * @property ImageLinkFactory $object_factory
     */
    ...
    public function __construct(ImageLinkFactory $object_factory, CollectionFactory $collection_factory, SearchResultInterfaceFactory $result_factory)
    {
    ...
    public function save(ImageLinkInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ImageLinkInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
