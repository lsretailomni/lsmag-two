...
use Ls\Replication\Api\ProductGroupRepositoryInterface;
use Ls\Replication\Model\ResourceModel\ProductGroup\CollectionFactory;
use Ls\Replication\Model\ResourceModel\ProductGroup\Collection;
use Ls\Replication\Api\Data\ProductGroupInterface;
use Ls\Replication\Model\ProductGroupFactory;

class ProductGroupRepository implements ProductGroupRepositoryInterface
{

    /**
     * @property ProductGroupFactory $object_factory
     */
    ...
    public function __construct(ProductGroupFactory $object_factory, CollectionFactory $collection_factory, SearchResultInterfaceFactory $result_factory)
    {
    ...
    public function save(ProductGroupInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ProductGroupInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
