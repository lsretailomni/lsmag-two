...
use Ls\Replication\Api\ItemUOMRepositoryInterface;
use Ls\Replication\Model\ResourceModel\ItemUOM\CollectionFactory;
use Ls\Replication\Model\ResourceModel\ItemUOM\Collection;
use Ls\Replication\Api\Data\ItemUOMInterface;
use Ls\Replication\Model\ItemUOMFactory;

class ItemUOMRepository implements ItemUOMRepositoryInterface
{

    /**
     * @property ItemUOMFactory $object_factory
     */
    ...
    public function __construct(ItemUOMFactory $object_factory, CollectionFactory $collection_factory, SearchResultInterfaceFactory $result_factory)
    {
    ...
    public function save(ItemUOMInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ItemUOMInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
