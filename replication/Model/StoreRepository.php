...
use Ls\Replication\Api\StoreRepositoryInterface;
use Ls\Replication\Model\ResourceModel\Store\CollectionFactory;
use Ls\Replication\Model\ResourceModel\Store\Collection;
use Ls\Replication\Api\Data\StoreInterface;
use Ls\Replication\Model\StoreFactory;

class StoreRepository implements StoreRepositoryInterface
{

    /**
     * @property StoreFactory $object_factory
     */
    ...
    public function __construct(StoreFactory $object_factory, CollectionFactory $collection_factory, SearchResultInterfaceFactory $result_factory)
    {
    ...
    public function save(StoreInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(StoreInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
