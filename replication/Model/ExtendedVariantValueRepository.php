...
class ExtendedVariantValueRepository implements ExtendedVariantValueRepositoryInterface
{

    /**
     * @property ExtendedVariantValueFactory $object_factory
     */
    ...
    public function __construct(ExtendedVariantValueFactory $object_factory, CollectionFactory $collection_factory, SearchResultInterfaceFactory $result_factory)
    {
    ...
    public function save(ExtendedVariantValueInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ExtendedVariantValueInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
