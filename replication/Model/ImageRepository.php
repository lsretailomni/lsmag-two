...
use Ls\Replication\Api\ImageRepositoryInterface;
use Ls\Replication\Model\ResourceModel\Image\CollectionFactory;
use Ls\Replication\Model\ResourceModel\Image\Collection;
use Ls\Replication\Api\Data\ImageInterface;
use Ls\Replication\Model\ImageFactory;

class ImageRepository implements ImageRepositoryInterface
{

    /**
     * @property ImageFactory $object_factory
     */
    ...
    public function __construct(ImageFactory $object_factory, CollectionFactory $collection_factory, SearchResultInterfaceFactory $result_factory)
    {
    ...
    public function save(ImageInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ImageInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
