...
class VendorItemMappingRepository implements VendorItemMappingRepositoryInterface
{

    /**
     * @property VendorItemMappingFactory $object_factory
     */
    ...
    public function __construct(VendorItemMappingFactory $object_factory, CollectionFactory $collection_factory, SearchResultInterfaceFactory $result_factory)
    {
    ...
    public function save(VendorItemMappingInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(VendorItemMappingInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
