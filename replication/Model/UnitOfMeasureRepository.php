...
use Ls\Replication\Api\UnitOfMeasureRepositoryInterface;
use Ls\Replication\Model\ResourceModel\UnitOfMeasure\CollectionFactory;
use Ls\Replication\Model\ResourceModel\UnitOfMeasure\Collection;
use Ls\Replication\Api\Data\UnitOfMeasureInterface;
use Ls\Replication\Model\UnitOfMeasureFactory;

class UnitOfMeasureRepository implements UnitOfMeasureRepositoryInterface
{

    /**
     * @property UnitOfMeasureFactory $object_factory
     */
    ...
    public function __construct(UnitOfMeasureFactory $object_factory, CollectionFactory $collection_factory, SearchResultInterfaceFactory $result_factory)
    {
    ...
    public function save(UnitOfMeasureInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(UnitOfMeasureInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
