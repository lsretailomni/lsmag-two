...
use Ls\Replication\Model\ResourceModel\Currency\CollectionFactory;
use Ls\Replication\Model\ResourceModel\Currency\Collection;
...
class CurrencyRepository implements CurrencyRepositoryInterface
{
    ...
    /**
     * @property CurrencyFactory $object_factory
     */
    ...
    public function __construct(CurrencyFactory $object_factory, CollectionFactory $collection_factory, SearchResultInterfaceFactory $result_factory)
    {
    ...
    public function save(CurrencyInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(CurrencyInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
