...
class PriceRepository implements PriceRepositoryInterface
{
    ...
    /**
     * @property PriceFactory $object_factory
     */
    ...
    public function __construct(PriceFactory $object_factory, CollectionFactory $collection_factory, SearchResultInterfaceFactory $result_factory)
    {
    ...
    public function save(PriceInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(PriceInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
