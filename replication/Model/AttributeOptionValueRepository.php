...
use Ls\Replication\Api\AttributeOptionValueRepositoryInterface;
use Ls\Replication\Model\ResourceModel\AttributeOptionValue\CollectionFactory;
use Ls\Replication\Model\ResourceModel\AttributeOptionValue\Collection;
use Ls\Replication\Api\Data\AttributeOptionValueInterface;
use Ls\Replication\Model\AttributeOptionValueFactory;

class AttributeOptionValueRepository implements AttributeOptionValueRepositoryInterface
{

    /**
     * @property AttributeOptionValueFactory $object_factory
     */
    ...
    public function __construct(AttributeOptionValueFactory $object_factory, CollectionFactory $collection_factory, SearchResultInterfaceFactory $result_factory)
    {
    ...
    public function save(AttributeOptionValueInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(AttributeOptionValueInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
