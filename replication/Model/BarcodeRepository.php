...
class BarcodeRepository implements BarcodeRepositoryInterface
{
    ...
    /**
     * @property BarcodeFactory $object_factory
     */
    ...
    public function __construct(BarcodeFactory $object_factory, CollectionFactory $collection_factory, SearchResultInterfaceFactory $result_factory)
    {
    ...
    public function save(BarcodeInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(BarcodeInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
