...
class ItemCategoryRepository implements ItemCategoryRepositoryInterface
{
    ...
    /**
     * @property ItemCategoryFactory $object_factory
     */
    ...
    public function __construct(ItemCategoryFactory $object_factory, CollectionFactory $collection_factory, SearchResultInterfaceFactory $result_factory)
    {
    ...
    public function save(ItemCategoryInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(ItemCategoryInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
