...
use Ls\Replication\Api\DataTranslationRepositoryInterface;
use Ls\Replication\Model\ResourceModel\DataTranslation\CollectionFactory;
use Ls\Replication\Model\ResourceModel\DataTranslation\Collection;
use Ls\Replication\Api\Data\DataTranslationInterface;
use Ls\Replication\Model\DataTranslationFactory;

class DataTranslationRepository implements DataTranslationRepositoryInterface
{

    /**
     * @property DataTranslationFactory $object_factory
     */
    ...
    public function __construct(DataTranslationFactory $object_factory, CollectionFactory $collection_factory, SearchResultInterfaceFactory $result_factory)
    {
    ...
    public function save(DataTranslationInterface $object)
    {
        try {
            $object->save();
        } catch ( Exception $e ) {
    ...
    public function delete(DataTranslationInterface $object)
    {
        try {
            $object->delete();
        } catch ( Exception $e) {
